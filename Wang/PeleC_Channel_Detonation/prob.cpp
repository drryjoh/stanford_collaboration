...
//  amrex::Real massfrac_l[NUM_SPECIES] = {0.0};
 // amrex::Real massfrac_r[NUM_SPECIES] = {0.0};
  ...
  amrex::Real massfrac_l[NUM_SPECIES] = {0, 0, 0.89440958, 0, 0, 0, 0.00475946, 0, 0, 0.10083097, 0, 0, 0, 0};
  amrex::Real massfrac_r[NUM_SPECIES] = {0.01277243, 0, 0.88586543, 0, 0, 0, 0, 0, 0, 0, 0, 0.10136214, 0, 0};
