        ...
        double forward_reaction_6 =  call_forward_reaction_6(species, temperature, log_temperature, species[8]);
        double forward_reaction_7 =  call_forward_reaction_7(species, temperature, log_temperature, mixture_concentration);
        double forward_reaction_8 =  call_forward_reaction_8(species, temperature, log_temperature, species[8]);
        ...
        double forward_reaction_11 =  call_forward_reaction_11(species, temperature, log_temperature, species[5]);
        double forward_reaction_12 =  call_forward_reaction_12(species, temperature, log_temperature, mixture_concentration);
        ...
        double forward_reaction_21 =  call_forward_reaction_21(species, temperature, log_temperature, mixture_concentration);
        ...
        double rate_of_progress_6 = multiply(species[1], forward_reaction_6) - multiply(pow_gen2(species[0]), divide(forward_reaction_6, equilibrium_constant_6));
        ...
        double rate_of_progress_7 = multiply(pow_gen2(species[2]), forward_reaction_7) - multiply(species[3], divide(forward_reaction_7, equilibrium_constant_7));
        double equilibrium_constant_8 = multiply(exp_gen(-gibbs_reactions[8]), inv_pressure_atmosphere() * universal_gas_constant() * temperature);
        double rate_of_progress_8 = multiply(pow_gen2(species[2]), forward_reaction_8) - multiply(species[3], divide(forward_reaction_8, equilibrium_constant_8));
        ...
        double rate_of_progress_9 = multiply(species[0] * species[2], forward_reaction_9) - multiply(species[4], divide(forward_reaction_9, equilibrium_constant_9));
        double equilibrium_constant_10 = multiply(exp_gen(-gibbs_reactions[10]), pressure_atmosphere() * inv_universal_gas_constant_temperature);
        double rate_of_progress_10 = multiply(species[5], forward_reaction_10) - multiply(species[0] * species[4], divide(forward_reaction_10, equilibrium_constant_10));
        double equilibrium_constant_11 = multiply(exp_gen(-gibbs_reactions[11]), pressure_atmosphere() * inv_universal_gas_constant_temperature);
        double rate_of_progress_11 = multiply(species[5], forward_reaction_11) - multiply(species[0] * species[4], divide(forward_reaction_11, equilibrium_constant_11));
        double equilibrium_constant_12 = multiply(exp_gen(-gibbs_reactions[12]), inv_pressure_atmosphere() * universal_gas_constant() * temperature);
        double rate_of_progress_12 = multiply(species[0] * species[3], forward_reaction_12) - multiply(species[6], divide(forward_reaction_12, equilibrium_constant_12));
        double equilibrium_constant_13 = multiply(exp_gen(-gibbs_reactions[13]), double(1.0));
        double rate_of_progress_13 = multiply(species[0] * species[6], forward_reaction_13) - multiply(species[1] * species[3], divide(forward_reaction_13, equilibrium_constant_13));
        double equilibrium_constant_14 = multiply(exp_gen(-gibbs_reactions[14]), double(1.0));
        double rate_of_progress_14 = multiply(species[0] * species[6], forward_reaction_14) - multiply(pow_gen2(species[4]), divide(forward_reaction_14, equilibrium_constant_14));
        double equilibrium_constant_15 = multiply(exp_gen(-gibbs_reactions[15]), double(1.0));
        double rate_of_progress_15 = multiply(species[0] * species[6], forward_reaction_15) - multiply(species[5] * species[2], divide(forward_reaction_15, equilibrium_constant_15));
        double equilibrium_constant_16 = multiply(exp_gen(-gibbs_reactions[16]), double(1.0));
        double rate_of_progress_16 = multiply(species[6] * species[2], forward_reaction_16) - multiply(species[3] * species[4], divide(forward_reaction_16, equilibrium_constant_16));
        double equilibrium_constant_17 = multiply(exp_gen(-gibbs_reactions[17]), double(1.0));
        double rate_of_progress_17 = multiply(species[6] * species[4], forward_reaction_17) - multiply(species[5] * species[3], divide(forward_reaction_17, equilibrium_constant_17));
        double equilibrium_constant_18 = multiply(exp_gen(-gibbs_reactions[18]), double(1.0));
        double rate_of_progress_18 = multiply(species[6] * species[4], forward_reaction_18) - multiply(species[5] * species[3], divide(forward_reaction_18, equilibrium_constant_18));
        double equilibrium_constant_19 = multiply(exp_gen(-gibbs_reactions[19]), double(1.0));
        double rate_of_progress_19 = multiply(pow_gen2(species[6]), forward_reaction_19) - multiply(species[7] * species[3], divide(forward_reaction_19, equilibrium_constant_19));
        double equilibrium_constant_20 = multiply(exp_gen(-gibbs_reactions[20]), double(1.0));
        double rate_of_progress_20 = multiply(pow_gen2(species[6]), forward_reaction_20) - multiply(species[7] * species[3], divide(forward_reaction_20, equilibrium_constant_20));
        double equilibrium_constant_21 = multiply(exp_gen(-gibbs_reactions[21]), pressure_atmosphere() * inv_universal_gas_constant_temperature);
        double rate_of_progress_21 = multiply(species[7], forward_reaction_21) - multiply(pow_gen2(species[4]), divide(forward_reaction_21, equilibrium_constant_21));
        double equilibrium_constant_22 = multiply(exp_gen(-gibbs_reactions[22]), double(1.0));
        double rate_of_progress_22 = multiply(species[0] * species[7], forward_reaction_22) - multiply(species[5] * species[4], divide(forward_reaction_22, equilibrium_constant_22));
        double equilibrium_constant_23 = multiply(exp_gen(-gibbs_reactions[23]), double(1.0));
        double rate_of_progress_23 = multiply(species[0] * species[7], forward_reaction_23) - multiply(species[1] * species[6], divide(forward_reaction_23, equilibrium_constant_23));
        double equilibrium_constant_24 = multiply(exp_gen(-gibbs_reactions[24]), double(1.0));
        double rate_of_progress_24 = multiply(species[7] * species[2], forward_reaction_24) - multiply(species[6] * species[4], divide(forward_reaction_24, equilibrium_constant_24));
        double equilibrium_constant_25 = multiply(exp_gen(-gibbs_reactions[25]), double(1.0));
        double rate_of_progress_25 = multiply(species[7] * species[4], forward_reaction_25) - multiply(species[5] * species[6], divide(forward_reaction_25, equilibrium_constant_25));
        double equilibrium_constant_26 = multiply(exp_gen(-gibbs_reactions[26]), double(1.0));
        double rate_of_progress_26 = multiply(species[7] * species[4], forward_reaction_26) - multiply(species[5] * species[6], divide(forward_reaction_26, equilibrium_constant_26));

        net_production_rates[0] = double(-1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_1 + double(1.0) * rate_of_progress_2 + double(1.0) * rate_of_progress_3 + double(2.0) * rate_of_progress_5 + double(2.0) * rate_of_progress_6 + double(-1.0) * rate_of_progress_9 + double(1.0) * rate_of_progress_10 + double(1.0) * rate_of_progress_11 + double(-1.0) * rate_of_progress_12 + double(-1.0) * rate_of_progress_13 + double(-1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_15 + double(-1.0) * rate_of_progress_22 + double(-1.0) * rate_of_progress_23;
        net_production_rates[1] = double(-1.0) * rate_of_progress_1 + double(-1.0) * rate_of_progress_2 + double(-1.0) * rate_of_progress_3 + double(-1.0) * rate_of_progress_5 + double(-1.0) * rate_of_progress_6 + double(1.0) * rate_of_progress_13 + double(1.0) * rate_of_progress_23;
        net_production_rates[2] = double(1.0) * rate_of_progress_0 + double(-1.0) * rate_of_progress_1 + double(-1.0) * rate_of_progress_2 + double(1.0) * rate_of_progress_4 + double(-2.0) * rate_of_progress_7 + double(-2.0) * rate_of_progress_8 + double(-1.0) * rate_of_progress_9 + double(1.0) * rate_of_progress_15 + double(-1.0) * rate_of_progress_16 + double(-1.0) * rate_of_progress_24;
        net_production_rates[3] = double(-1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_7 + double(1.0) * rate_of_progress_8 + double(-1.0) * rate_of_progress_12 + double(1.0) * rate_of_progress_13 + double(1.0) * rate_of_progress_16 + double(1.0) * rate_of_progress_17 + double(1.0) * rate_of_progress_18 + double(1.0) * rate_of_progress_19 + double(1.0) * rate_of_progress_20;
        net_production_rates[4] = double(1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_1 + double(1.0) * rate_of_progress_2 + double(-1.0) * rate_of_progress_3 + double(-2.0) * rate_of_progress_4 + double(1.0) * rate_of_progress_9 + double(1.0) * rate_of_progress_10 + double(1.0) * rate_of_progress_11 + double(2.0) * rate_of_progress_14 + double(1.0) * rate_of_progress_16 + double(-1.0) * rate_of_progress_17 + double(-1.0) * rate_of_progress_18 + double(2.0) * rate_of_progress_21 + double(1.0) * rate_of_progress_22 + double(1.0) * rate_of_progress_24 + double(-1.0) * rate_of_progress_25 + double(-1.0) * rate_of_progress_26;
        net_production_rates[5] = double(1.0) * rate_of_progress_3 + double(1.0) * rate_of_progress_4 + double(-1.0) * rate_of_progress_10 + double(-1.0) * rate_of_progress_11 + double(1.0) * rate_of_progress_15 + double(1.0) * rate_of_progress_17 + double(1.0) * rate_of_progress_18 + double(1.0) * rate_of_progress_22 + double(1.0) * rate_of_progress_25 + double(1.0) * rate_of_progress_26;
        net_production_rates[6] = double(1.0) * rate_of_progress_12 + double(-1.0) * rate_of_progress_13 + double(-1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_15 + double(-1.0) * rate_of_progress_16 + double(-1.0) * rate_of_progress_17 + double(-1.0) * rate_of_progress_18 + double(-2.0) * rate_of_progress_19 + double(-2.0) * rate_of_progress_20 + double(1.0) * rate_of_progress_23 + double(1.0) * rate_of_progress_24 + double(1.0) * rate_of_progress_25 + double(1.0) * rate_of_progress_26;
        net_production_rates[7] = double(1.0) * rate_of_progress_19 + double(1.0) * rate_of_progress_20 + double(-1.0) * rate_of_progress_21 + double(-1.0) * rate_of_progress_22 + double(-1.0) * rate_of_progress_23 + double(-1.0) * rate_of_progress_24 + double(-1.0) * rate_of_progress_25 + double(-1.0) * rate_of_progress_26;
...
{
                double forward_reaction_6 =  call_forward_reaction_6(species, temperature, log_temperature, species[8]);
        double dforward_reaction_6_dtemperature = dcall_forward_reaction_6_dtemperature(species,temperature,log_temperature,species[8]);


        dforward_reaction_6_dtemperature += dcall_forward_reaction_6_dlog_temperature(species,temperature,log_temperature,species[8]) * dlog_temperature_dtemperature;


        

        // Reaction 6: H2 + AR <=> 2 H + AR

        double drate_of_progress_6_dtemperature =
        multiply(species[1], dforward_reaction_6_dtemperature)
        -
        multiply(pow_gen2(species[0]),
        ...
        dsource_species_dtemperature_[0] += 2.0*drate_of_progress_6_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[2]), dforward_reaction_7_dtemperature)
        -
        multiply(species[3],
        ...
        dsource_species_dtemperature_[2] += -2.0*drate_of_progress_7_dtemperature;
...
{
                double forward_reaction_8 =  call_forward_reaction_8(species, temperature, log_temperature, species[8]);
        double dforward_reaction_8_dtemperature = dcall_forward_reaction_8_dtemperature(species,temperature,log_temperature,species[8]);


        dforward_reaction_8_dtemperature += dcall_forward_reaction_8_dlog_temperature(species,temperature,log_temperature,species[8]) * dlog_temperature_dtemperature;


        

        // Reaction 8: 2 O + AR <=> O2 + AR

        double drate_of_progress_8_dtemperature =
        multiply(pow_gen2(species[2]), dforward_reaction_8_dtemperature)
        -
        multiply(species[3],
        ...
        dsource_species_dtemperature_[2] += -2.0*drate_of_progress_8_dtemperature;
        dsource_species_dtemperature_[3] += drate_of_progress_8_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[0] * species[2], dforward_reaction_9_dtemperature)
        -
        multiply(species[4],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 10: H2O + M <=> H + OH + M

        double drate_of_progress_10_dtemperature =
        multiply(species[5], dforward_reaction_10_dtemperature)
        -
        multiply(species[0] * species[4],
...
{
                double forward_reaction_11 =  call_forward_reaction_11(species, temperature, log_temperature, species[5]);
        double dforward_reaction_11_dtemperature = dcall_forward_reaction_11_dtemperature(species,temperature,log_temperature,species[5]);


        dforward_reaction_11_dtemperature += dcall_forward_reaction_11_dlog_temperature(species,temperature,log_temperature,species[5]) * dlog_temperature_dtemperature;


        

        // Reaction 11: H2O + H2O <=> H + OH + H2O

        double drate_of_progress_11_dtemperature =
        multiply(species[5], dforward_reaction_11_dtemperature)
        -
        multiply(species[0] * species[4],
...
{
                double forward_reaction_12 =  call_forward_reaction_12(species, temperature, log_temperature, mixture_concentration);
        double dforward_reaction_12_dtemperature = dcall_forward_reaction_12_dtemperature(species,temperature,log_temperature,mixture_concentration);


        dforward_reaction_12_dtemperature += dcall_forward_reaction_12_dlog_temperature(species,temperature,log_temperature,mixture_concentration) * dlog_temperature_dtemperature;
        ...
        multiply(species[0] * species[3], dforward_reaction_12_dtemperature)
        -
        multiply(species[6],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[0] * species[6], dforward_reaction_14_dtemperature)
        -
        ...
        dsource_species_dtemperature_[0] += -drate_of_progress_14_dtemperature;
        dsource_species_dtemperature_[6] += -drate_of_progress_14_dtemperature;
        dsource_species_dtemperature_[4] += 2.0*drate_of_progress_14_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[0] * species[6], dforward_reaction_15_dtemperature)
        -
        multiply(species[5] * species[2],
        ...
        dsource_species_dtemperature_[0] += -drate_of_progress_15_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[6] * species[2], dforward_reaction_16_dtemperature)
        -
        ...
        dsource_species_dtemperature_[2] += -drate_of_progress_16_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[6] * species[4], dforward_reaction_17_dtemperature)
        -
        ...
        dsource_species_dtemperature_[6] += -drate_of_progress_17_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[6] * species[4], dforward_reaction_18_dtemperature)
        -
        multiply(species[5] * species[3],
        ...
        dsource_species_dtemperature_[6] += -drate_of_progress_18_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[6]), dforward_reaction_19_dtemperature)
        -
        ...
        dsource_species_dtemperature_[3] += drate_of_progress_19_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[6]), dforward_reaction_20_dtemperature)
        -
        multiply(species[7] * species[3],
        ...
        dsource_species_dtemperature_[6] += -2.0*drate_of_progress_20_dtemperature;
        dsource_species_dtemperature_[7] += drate_of_progress_20_dtemperature;
        dsource_species_dtemperature_[3] += drate_of_progress_20_dtemperature;
}
...
{
                double forward_reaction_21 =  call_forward_reaction_21(species, temperature, log_temperature, mixture_concentration);
        double dforward_reaction_21_dtemperature = dcall_forward_reaction_21_dtemperature(species,temperature,log_temperature,mixture_concentration);


        dforward_reaction_21_dtemperature += dcall_forward_reaction_21_dlog_temperature(species,temperature,log_temperature,mixture_concentration) * dlog_temperature_dtemperature;


        

        // Reaction 21: H2O2 (+M) <=> 2 OH (+M)

        double drate_of_progress_21_dtemperature =
        multiply(species[7], dforward_reaction_21_dtemperature)
        -
        multiply(pow_gen2(species[4]),
        ...
        dsource_species_dtemperature_[4] += 2.0*drate_of_progress_21_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[0] * species[7], dforward_reaction_22_dtemperature)
        -
        ...
        dsource_species_dtemperature_[0] += -drate_of_progress_22_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 23: H + H2O2 <=> H2 + HO2

        double drate_of_progress_23_dtemperature =
        multiply(species[0] * species[7], dforward_reaction_23_dtemperature)
        -
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 24: H2O2 + O <=> HO2 + OH

        double drate_of_progress_24_dtemperature =
        multiply(species[7] * species[2], dforward_reaction_24_dtemperature)
        -
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[7] * species[4], dforward_reaction_25_dtemperature)
        -
        ...
        dsource_species_dtemperature_[6] += drate_of_progress_25_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[7] * species[4], dforward_reaction_26_dtemperature)
        -
        multiply(species[5] * species[6],
        ...
        dsource_species_dtemperature_[6] += drate_of_progress_26_dtemperature;
}
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[2][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][2] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[0]), divide(forward_reaction_6, equilibrium_constant_6));// 6 0
        jacobian_net_production_rates[2][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][1] += 2.0*drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[4][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_7, equilibrium_constant_7); //7 3
        jacobian_net_production_rates[3][4] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += drate_of_progress_dspecies;


        Species drate_of_progress_dspecies_all_species =
        scale_gen(pow_gen2(species[2]) - divide(species[3], equilibrium_constant_7),
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[3][3] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[4][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_8, equilibrium_constant_8); //8 3
        jacobian_net_production_rates[3][4] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_9, equilibrium_constant_9); //9 4
        jacobian_net_production_rates[1][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[0] * species[2] - divide(species[4], equilibrium_constant_9),
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[1][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_10, equilibrium_constant_10));// 10 0
        jacobian_net_production_rates[6][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][1] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][1] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[0], divide(forward_reaction_10, equilibrium_constant_10));// 10 4
        jacobian_net_production_rates[6][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[5] - divide(species[0] * species[4], equilibrium_constant_10),
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[1][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_11, equilibrium_constant_11));// 11 0
        jacobian_net_production_rates[6][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][1] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][1] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[0], divide(forward_reaction_11, equilibrium_constant_11));// 11 4
        jacobian_net_production_rates[6][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[5] - divide(species[0] * species[4], equilibrium_constant_11),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = -divide(forward_reaction_12, equilibrium_constant_12); //12 6
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[0] * species[3] - divide(species[6], equilibrium_constant_12),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = -multiply(species[1], divide(forward_reaction_13, equilibrium_constant_13));
        jacobian_net_production_rates[1][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][4] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[4]), divide(forward_reaction_14, equilibrium_constant_14));
        jacobian_net_production_rates[1][5] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[4][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_19, equilibrium_constant_19));
        ...
        jacobian_net_production_rates[4][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[3], divide(forward_reaction_19, equilibrium_constant_19));
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[8][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[3], divide(forward_reaction_20, equilibrium_constant_20));
        jacobian_net_production_rates[7][8] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[4][8] += drate_of_progress_dspecies;
}
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[4]), divide(forward_reaction_21, equilibrium_constant_21));// 21 4
        jacobian_net_production_rates[8][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += 2.0*drate_of_progress_dspecies;


        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[7] - divide(pow_gen2(species[4]), equilibrium_constant_21),
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[2][2] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[1], divide(forward_reaction_23, equilibrium_constant_23));
        jacobian_net_production_rates[1][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[6][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_25, equilibrium_constant_25));
        jacobian_net_production_rates[8][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_25, equilibrium_constant_25));
        jacobian_net_production_rates[8][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[6][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_26, equilibrium_constant_26));
        jacobian_net_production_rates[8][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
