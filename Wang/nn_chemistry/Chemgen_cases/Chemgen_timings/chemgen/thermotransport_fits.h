...
species_specific_heat_constant_pressure_mass_specific(const TemperatureMonomial& temperature_monomial_sequence)  
{
        ...
        contract(temperature_monomial_sequence, TemperatureMonomial{double(520.3042940020794), double(1.863297421595214e-15), double(-2.601734022325762e-18), double(1.634104839471318e-21), double(-5.262224619625481e-25), double(8.907734870578682e-29), double(-7.530411517384767e-33), double(2.5091134477764188e-37)})};
...
species_specific_heat_constant_volume_mass_specific(const TemperatureMonomial& temperature_monomial_sequence)  
{
        ...
        contract(temperature_monomial_sequence, TemperatureMonomial{double(312.18257640124733), double(1.863297421595214e-15), double(-2.601734022325762e-18), double(1.634104839471318e-21), double(-5.262224619625481e-25), double(8.907734870578682e-29), double(-7.530411517384767e-33), double(2.5091134477764188e-37)})};
...
species_enthalpy_mass_specific(const TemperatureEnergyMonomial& temperature_energy_monomial_sequence)  
{
        ...
        contract(temperature_energy_monomial_sequence, TemperatureEnergyMonomial{double(-155128.72525672003), double(520.3042940020794), double(9.31648710797607e-16), double(-8.672446741085874e-19), double(4.085262098678295e-22), double(-1.0524449239250962e-25), double(1.4846224784297803e-29), double(-1.0757730739121095e-33), double(3.1363918097205235e-38)})};
...
species_internal_energy_mass_specific(const TemperatureEnergyMonomial& temperature_energy_monomial_sequence)  
{
        ...
        contract(temperature_energy_monomial_sequence, TemperatureEnergyMonomial{double(-155128.72525672003), double(312.18257640124733), double(9.31648710797607e-16), double(-8.672446741085874e-19), double(4.085262098678295e-22), double(-1.0524449239250962e-25), double(1.4846224784297803e-29), double(-1.0757730739121095e-33), double(3.1363918097205235e-38)})};
...
species_entropy_mass_specific(const TemperatureEnergyMonomial& temperature_entropy_monomial_sequence)  
{
        ...
        contract(temperature_entropy_monomial_sequence, TemperatureEnergyMonomial{double(911.5054648024734), double(1.863297421595214e-15), double(-1.300867011162881e-18), double(5.44701613157106e-22), double(-1.3155561549063702e-25), double(1.7815469741157364e-29), double(-1.2550685862307945e-33), double(3.584447782537741e-38), double(520.3042940020794)})};
...
species_gibbs_energy_mole_specific(const TemperatureGibbsMonomial& temperature_gibbs_monomial_sequence)  
{
        ...
        contract(temperature_gibbs_monomial_sequence, TemperatureGibbsMonomial{double(-6197392.574005966), double(-15628.486773475743), double(-3.72193659963644e-14), double(1.7323212365319036e-17), double(-5.440207361406595e-21), double(1.0511293677701897e-24), double(-1.1862133602653953e-28), double(7.162855717131463e-33), double(0.0), double(-20786.156545383074)})};
...
gibbs_reaction(const TemperatureMonomial& log_temperature_monomial_sequence)  
{
        return
        Reactions{
        contract(log_temperature_monomial_sequence, TemperatureMonomial{double