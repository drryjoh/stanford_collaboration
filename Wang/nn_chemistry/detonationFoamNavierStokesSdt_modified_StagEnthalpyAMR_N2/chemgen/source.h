        ...
        double forward_reaction_9 =  call_forward_reaction_9(species, temperature, log_temperature, species[6]);
        ...
        double rate_of_progress_0 = multiply(species[1] * species[4], forward_reaction_0) - multiply(species[3] * species[5], divide(forward_reaction_0, equilibrium_constant_0));
        double equilibrium_constant_1 = multiply(exp_gen(-gibbs_reactions[1]), double(1.0));
        double rate_of_progress_1 = multiply(species[2] * species[3], forward_reaction_1) - multiply(species[1] * species[5], divide(forward_reaction_1, equilibrium_constant_1));
        double equilibrium_constant_2 = multiply(exp_gen(-gibbs_reactions[2]), double(1.0));
        double rate_of_progress_2 = multiply(species[2] * species[3], forward_reaction_2) - multiply(species[1] * species[5], divide(forward_reaction_2, equilibrium_constant_2));
        double equilibrium_constant_3 = multiply(exp_gen(-gibbs_reactions[3]), double(1.0));
        double rate_of_progress_3 = multiply(species[2] * species[5], forward_reaction_3) - multiply(species[1] * species[6], divide(forward_reaction_3, equilibrium_constant_3));
        double equilibrium_constant_4 = multiply(exp_gen(-gibbs_reactions[4]), double(1.0));
        double rate_of_progress_4 = multiply(pow_gen2(species[5]), forward_reaction_4) - multiply(species[6] * species[3], divide(forward_reaction_4, equilibrium_constant_4));
        ...
        double rate_of_progress_5 = multiply(species[2], forward_reaction_5) - multiply(pow_gen2(species[1]), divide(forward_reaction_5, equilibrium_constant_5));
        ...
        double rate_of_progress_6 = multiply(pow_gen2(species[3]), forward_reaction_6) - multiply(species[4], divide(forward_reaction_6, equilibrium_constant_6));
        ...
        double rate_of_progress_7 = multiply(species[1] * species[3], forward_reaction_7) - multiply(species[5], divide(forward_reaction_7, equilibrium_constant_7));
        ...
        double rate_of_progress_8 = multiply(species[6], forward_reaction_8) - multiply(species[1] * species[5], divide(forward_reaction_8, equilibrium_constant_8));
        ...
        double rate_of_progress_9 = multiply(species[6], forward_reaction_9) - multiply(species[1] * species[5], divide(forward_reaction_9, equilibrium_constant_9));
        ...
        double rate_of_progress_10 = multiply(species[1] * species[4], forward_reaction_10) - multiply(species[7], divide(forward_reaction_10, equilibrium_constant_10));
        double equilibrium_constant_11 = multiply(exp_gen(-gibbs_reactions[11]), double(1.0));
        double rate_of_progress_11 = multiply(species[1] * species[7], forward_reaction_11) - multiply(species[2] * species[4], divide(forward_reaction_11, equilibrium_constant_11));
        double equilibrium_constant_12 = multiply(exp_gen(-gibbs_reactions[12]), double(1.0));
        double rate_of_progress_12 = multiply(species[1] * species[7], forward_reaction_12) - multiply(pow_gen2(species[5]), divide(forward_reaction_12, equilibrium_constant_12));
        double equilibrium_constant_13 = multiply(exp_gen(-gibbs_reactions[13]), double(1.0));
        double rate_of_progress_13 = multiply(species[1] * species[7], forward_reaction_13) - multiply(species[6] * species[3], divide(forward_reaction_13, equilibrium_constant_13));
        double equilibrium_constant_14 = multiply(exp_gen(-gibbs_reactions[14]), double(1.0));
        double rate_of_progress_14 = multiply(species[7] * species[3], forward_reaction_14) - multiply(species[4] * species[5], divide(forward_reaction_14, equilibrium_constant_14));
        double equilibrium_constant_15 = multiply(exp_gen(-gibbs_reactions[15]), double(1.0));
        double rate_of_progress_15 = multiply(species[7] * species[5], forward_reaction_15) - multiply(species[6] * species[4], divide(forward_reaction_15, equilibrium_constant_15));
        double equilibrium_constant_16 = multiply(exp_gen(-gibbs_reactions[16]), double(1.0));
        double rate_of_progress_16 = multiply(species[7] * species[5], forward_reaction_16) - multiply(species[6] * species[4], divide(forward_reaction_16, equilibrium_constant_16));
        double equilibrium_constant_17 = multiply(exp_gen(-gibbs_reactions[17]), double(1.0));
        double rate_of_progress_17 = multiply(pow_gen2(species[7]), forward_reaction_17) - multiply(species[8] * species[4], divide(forward_reaction_17, equilibrium_constant_17));
        double equilibrium_constant_18 = multiply(exp_gen(-gibbs_reactions[18]), double(1.0));
        double rate_of_progress_18 = multiply(pow_gen2(species[7]), forward_reaction_18) - multiply(species[8] * species[4], divide(forward_reaction_18, equilibrium_constant_18));
        ...
        double rate_of_progress_19 = multiply(species[8], forward_reaction_19) - multiply(pow_gen2(species[5]), divide(forward_reaction_19, equilibrium_constant_19));
        double equilibrium_constant_20 = multiply(exp_gen(-gibbs_reactions[20]), double(1.0));
        double rate_of_progress_20 = multiply(species[1] * species[8], forward_reaction_20) - multiply(species[6] * species[5], divide(forward_reaction_20, equilibrium_constant_20));
        double equilibrium_constant_21 = multiply(exp_gen(-gibbs_reactions[21]), double(1.0));
        double rate_of_progress_21 = multiply(species[1] * species[8], forward_reaction_21) - multiply(species[2] * species[7], divide(forward_reaction_21, equilibrium_constant_21));
        double equilibrium_constant_22 = multiply(exp_gen(-gibbs_reactions[22]), double(1.0));
        double rate_of_progress_22 = multiply(species[8] * species[3], forward_reaction_22) - multiply(species[7] * species[5], divide(forward_reaction_22, equilibrium_constant_22));
        double equilibrium_constant_23 = multiply(exp_gen(-gibbs_reactions[23]), double(1.0));
        double rate_of_progress_23 = multiply(species[8] * species[5], forward_reaction_23) - multiply(species[6] * species[7], divide(forward_reaction_23, equilibrium_constant_23));
        double equilibrium_constant_24 = multiply(exp_gen(-gibbs_reactions[24]), double(1.0));
        double rate_of_progress_24 = multiply(species[8] * species[5], forward_reaction_24) - multiply(species[6] * species[7], divide(forward_reaction_24, equilibrium_constant_24));

        //source_0 has no production term
        ...
        net_production_rates[2] = double(-1.0) * rate_of_progress_1 + double(-1.0) * rate_of_progress_2 + double(-1.0) * rate_of_progress_3 + double(-1.0) * rate_of_progress_5 + double(1.0) * rate_of_progress_11 + double(1.0) * rate_of_progress_21;
        net_production_rates[3] = double(1.0) * rate_of_progress_0 + double(-1.0) * rate_of_progress_1 + double(-1.0) * rate_of_progress_2 + double(1.0) * rate_of_progress_4 + double(-2.0) * rate_of_progress_6 + double(-1.0) * rate_of_progress_7 + double(1.0) * rate_of_progress_13 + double(-1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_22;
        net_production_rates[4] = double(-1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_6 + double(-1.0) * rate_of_progress_10 + double(1.0) * rate_of_progress_11 + double(1.0) * rate_of_progress_14 + double(1.0) * rate_of_progress_15 + double(1.0) * rate_of_progress_16 + double(1.0) * rate_of_progress_17 + double(1.0) * rate_of_progress_18;
        net_production_rates[5] = double(1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_1 + double(1.0) * rate_of_progress_2 + double(-1.0) * rate_of_progress_3 + double(-2.0) * rate_of_progress_4 + double(1.0) * rate_of_progress_7 + double(1.0) * rate_of_progress_8 + double(1.0) * rate_of_progress_9 + double(2.0) * rate_of_progress_12 + double(1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_15 + double(-1.0) * rate_of_progress_16 + double(2.0) * rate_of_progress_19 + double(1.0) * rate_of_progress_20 + double(1.0) * rate_of_progress_22 + double(-1.0) * rate_of_progress_23 + double(-1.0) * rate_of_progress_24;
        net_production_rates[6] = double(1.0) * rate_of_progress_3 + double(1.0) * rate_of_progress_4 + double(-1.0) * rate_of_progress_8 + double(-1.0) * rate_of_progress_9 + double(1.0) * rate_of_progress_13 + double(1.0) * rate_of_progress_15 + double(1.0) * rate_of_progress_16 + double(1.0) * rate_of_progress_20 + double(1.0) * rate_of_progress_23 + double(1.0) * rate_of_progress_24;
        net_production_rates[7] = double(1.0) * rate_of_progress_10 + double(-1.0) * rate_of_progress_11 + double(-1.0) * rate_of_progress_12 + double(-1.0) * rate_of_progress_13 + double(-1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_15 + double(-1.0) * rate_of_progress_16 + double(-2.0) * rate_of_progress_17 + double(-2.0) * rate_of_progress_18 + double(1.0) * rate_of_progress_21 + double(1.0) * rate_of_progress_22 + double(1.0) * rate_of_progress_23 + double(1.0) * rate_of_progress_24;
        net_production_rates[8] = double(1.0) * rate_of_progress_17 + double(1.0) * rate_of_progress_18 + double(-1.0) * rate_of_progress_19 + double(-1.0) * rate_of_progress_20 + double(-1.0) * rate_of_progress_21 + double(-1.0) * rate_of_progress_22 + double(-1.0) * rate_of_progress_23 + double(-1.0) * rate_of_progress_24;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[4], dforward_reaction_0_dtemperature)
        -
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[3], dforward_reaction_1_dtemperature)
        -
        ...
        dsource_species_dtemperature_[5] += drate_of_progress_1_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[3], dforward_reaction_2_dtemperature)
        -
        multiply(species[1] * species[5],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[5], dforward_reaction_3_dtemperature)
        -
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[5]), dforward_reaction_4_dtemperature)
        -
        ...
        dsource_species_dtemperature_[5] += -2.0*drate_of_progress_4_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2], dforward_reaction_5_dtemperature)
        -
        ...
        dsource_species_dtemperature_[2] += -drate_of_progress_5_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[3]), dforward_reaction_6_dtemperature)
        -
        multiply(species[4],
        ...
        dsource_species_dtemperature_[3] += -2.0*drate_of_progress_6_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[3], dforward_reaction_7_dtemperature)
        -
        multiply(species[5],
        ...
        dsource_species_dtemperature_[3] += -drate_of_progress_7_dtemperature;
        dsource_species_dtemperature_[5] += drate_of_progress_7_dtemperature;
}
...
{
                double forward_reaction_9 =  call_forward_reaction_9(species, temperature, log_temperature, species[6]);
        double dforward_reaction_9_dtemperature = dcall_forward_reaction_9_dtemperature(species,temperature,log_temperature,species[6]);


        dforward_reaction_9_dtemperature += dcall_forward_reaction_9_dlog_temperature(species,temperature,log_temperature,species[6]) * dlog_temperature_dtemperature;
        ...
        multiply(species[6], dforward_reaction_9_dtemperature)
        -
        multiply(species[1] * species[5],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[4], dforward_reaction_10_dtemperature)
        -
        multiply(species[7],
        ...
        dsource_species_dtemperature_[4] += -drate_of_progress_10_dtemperature;
        dsource_species_dtemperature_[7] += drate_of_progress_10_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[7], dforward_reaction_11_dtemperature)
        -
        ...
        dsource_species_dtemperature_[7] += -drate_of_progress_11_dtemperature;
        dsource_species_dtemperature_[2] += drate_of_progress_11_dtemperature;
        dsource_species_dtemperature_[4] += drate_of_progress_11_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[7], dforward_reaction_12_dtemperature)
        -
        ...
        dsource_species_dtemperature_[7] += -drate_of_progress_12_dtemperature;
        dsource_species_dtemperature_[5] += 2.0*drate_of_progress_12_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[7], dforward_reaction_13_dtemperature)
        -
        multiply(species[6] * species[3],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[7] * species[3], dforward_reaction_14_dtemperature)
        -
        ...
        dsource_species_dtemperature_[7] += -drate_of_progress_14_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[7] * species[5], dforward_reaction_15_dtemperature)
        -
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[7] * species[5], dforward_reaction_16_dtemperature)
        -
        multiply(species[6] * species[4],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[7]), dforward_reaction_17_dtemperature)
        -
        ...
        dsource_species_dtemperature_[7] += -2.0*drate_of_progress_17_dtemperature;
        dsource_species_dtemperature_[8] += drate_of_progress_17_dtemperature;
        dsource_species_dtemperature_[4] += drate_of_progress_17_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[7]), dforward_reaction_18_dtemperature)
        -
        multiply(species[8] * species[4],
        ...
        dsource_species_dtemperature_[7] += -2.0*drate_of_progress_18_dtemperature;
        dsource_species_dtemperature_[8] += drate_of_progress_18_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[8], dforward_reaction_19_dtemperature)
        -
        multiply(pow_gen2(species[5]),
        ...
        dsource_species_dtemperature_[8] += -drate_of_progress_19_dtemperature;
        dsource_species_dtemperature_[5] += 2.0*drate_of_progress_19_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[8], dforward_reaction_20_dtemperature)
        -
        multiply(species[6] * species[5],
        ...
        dsource_species_dtemperature_[8] += -drate_of_progress_20_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[1] * species[8], dforward_reaction_21_dtemperature)
        -
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        dsource_species_dtemperature_[5] += drate_of_progress_22_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[8] * species[5], dforward_reaction_23_dtemperature)
        -
        multiply(species[6] * species[7],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[8] * species[5], dforward_reaction_24_dtemperature)
        -
        multiply(species[6] * species[7],
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_0); // [0][1] +
        ...
        drate_of_progress_dspecies = multiply(species[1], forward_reaction_0); // [0][4] +
        ...
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_0, equilibrium_constant_0));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[3], forward_reaction_1); // [1][2] +
        ...
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_1); // [1][3] +
        jacobian_net_production_rates[3][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_1, equilibrium_constant_1));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[3], forward_reaction_2); // [2][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_2); // [2][3] +
        jacobian_net_production_rates[3][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_2, equilibrium_constant_2));
        jacobian_net_production_rates[3][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][2] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][2] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[5], forward_reaction_3); // [3][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_3); // [3][5] +
        jacobian_net_production_rates[3][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][6] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[5]), forward_reaction_4); // [4][5] +
        ...
        jacobian_net_production_rates[6][4] += -2.0*drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_5;// 5 2 
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        ...
        scale_gen(species[2] - divide(pow_gen2(species[1]), equilibrium_constant_5),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[3]), forward_reaction_6);//6 3
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(pow_gen2(species[3]) - divide(species[4], equilibrium_constant_6),
                  dforward_reaction_6_dspecies);
        jacobian_net_production_rates[4] = add_species_to_chemical_state(jacobian_net_production_rates[4], scale_gen(-2.0, drate_of_progress_dspecies_all_species));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[3], forward_reaction_7);//7 1
        jacobian_net_production_rates[2][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[1], forward_reaction_7);//7 3
        jacobian_net_production_rates[2][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_7, equilibrium_constant_7); //7 5
        jacobian_net_production_rates[2][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[1] * species[3] - divide(species[5], equilibrium_constant_7),
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[2][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_8, equilibrium_constant_8));// 8 1
        jacobian_net_production_rates[7][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][2] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[1], divide(forward_reaction_8, equilibrium_constant_8));// 8 5
        jacobian_net_production_rates[7][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[6] - divide(species[1] * species[5], equilibrium_constant_8),
                                               ...
                                               const double& dlog_temperature_dtemperature)
{
        ...
        Species dforward_reaction_9_dspecies = dcall_forward_reaction_9_dspecies(species,temperature,log_temperature,species[6]);
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_9;// 9 6 
        jacobian_net_production_rates[7][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_9, equilibrium_constant_9));// 9 1
        jacobian_net_production_rates[7][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][2] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[1], divide(forward_reaction_9, equilibrium_constant_9));// 9 5
        jacobian_net_production_rates[7][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[2][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[6] - divide(species[1] * species[5], equilibrium_constant_9),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_10);//10 1
        jacobian_net_production_rates[2][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[1], forward_reaction_10);//10 4
        jacobian_net_production_rates[2][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_10, equilibrium_constant_10); //10 7
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[1] * species[4] - divide(species[7], equilibrium_constant_10),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[7], forward_reaction_11); // [11][1] +
        jacobian_net_production_rates[2][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][2] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[1], forward_reaction_11); // [11][7] +
        jacobian_net_production_rates[2][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_11, equilibrium_constant_11));
        jacobian_net_production_rates[2][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[2], divide(forward_reaction_11, equilibrium_constant_11));
        jacobian_net_production_rates[2][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][5] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[7], forward_reaction_12); // [12][1] +
        jacobian_net_production_rates[2][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][2] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[1], forward_reaction_12); // [12][7] +
        jacobian_net_production_rates[2][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][8] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[5]), divide(forward_reaction_12, equilibrium_constant_12));
        jacobian_net_production_rates[2][6] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[7], forward_reaction_13); // [13][1] +
        jacobian_net_production_rates[2][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][2] += drate_of_progress_dspecies;
        jacobian_net_production_rates[4][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[1], forward_reaction_13); // [13][7] +
        jacobian_net_production_rates[2][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[4][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_13, equilibrium_constant_13));
        jacobian_net_production_rates[2][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[3], divide(forward_reaction_13, equilibrium_constant_13));
        jacobian_net_production_rates[2][7] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[7], forward_reaction_14); // [14][3] +
        jacobian_net_production_rates[8][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[3], forward_reaction_14); // [14][7] +
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][8] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[7], forward_reaction_15); // [15][5] +
        jacobian_net_production_rates[8][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[5], forward_reaction_15); // [15][7] +
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][8] += drate_of_progress_dspecies;
        ...
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_15, equilibrium_constant_15));
        jacobian_net_production_rates[8][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[7], forward_reaction_16); // [16][5] +
        jacobian_net_production_rates[8][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[5], forward_reaction_16); // [16][7] +
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_16, equilibrium_constant_16));
        jacobian_net_production_rates[8][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_16, equilibrium_constant_16));
        jacobian_net_production_rates[8][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][7] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[7]), forward_reaction_17); // [17][7] +
        jacobian_net_production_rates[8][8] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[9][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_17, equilibrium_constant_17));
        jacobian_net_production_rates[8][5] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[9][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_17, equilibrium_constant_17));
        jacobian_net_production_rates[8][9] += -2.0*drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[7]), forward_reaction_18); // [18][7] +
        jacobian_net_production_rates[8][8] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[9][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_18, equilibrium_constant_18));
        jacobian_net_production_rates[8][5] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[9][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_18, equilibrium_constant_18));
        jacobian_net_production_rates[8][9] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[9][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][9] += drate_of_progress_dspecies;
}
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_19;// 19 8 
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[5]), divide(forward_reaction_19, equilibrium_constant_19));// 19 5
        jacobian_net_production_rates[9][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += 2.0*drate_of_progress_dspecies;


        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[8] - divide(pow_gen2(species[5]), equilibrium_constant_19),
        ...
        jacobian_net_production_rates[6] = add_species_to_chemical_state(jacobian_net_production_rates[6], scale_gen(2.0, drate_of_progress_dspecies_all_species));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_20); // [20][1] +
        jacobian_net_production_rates[2][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][2] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][2] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][2] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[1], forward_reaction_20); // [20][8] +
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[3][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[2], divide(forward_reaction_21, equilibrium_constant_21));
        jacobian_net_production_rates[2][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        jacobian_net_production_rates[8][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_22, equilibrium_constant_22));
        jacobian_net_production_rates[9][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][8] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_23); // [23][5] +
        jacobian_net_production_rates[9][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[5], forward_reaction_23); // [23][8] +
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][9] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_24); // [24][5] +
        jacobian_net_production_rates[9][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[5], forward_reaction_24); // [24][8] +
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][9] += drate_of_progress_dspecies;
