        ...
        double forward_reaction_9 =  call_forward_reaction_9(species, temperature, log_temperature, species[7]);
        ...
        double forward_reaction_25 =  call_forward_reaction_25(species, temperature, log_temperature, mixture_concentration);
        ...
        double rate_of_progress_0 = multiply(species[2] * species[5], forward_reaction_0) - multiply(species[4] * species[6], divide(forward_reaction_0, equilibrium_constant_0));
        double equilibrium_constant_1 = multiply(exp_gen(-gibbs_reactions[1]), double(1.0));
        double rate_of_progress_1 = multiply(species[3] * species[4], forward_reaction_1) - multiply(species[2] * species[6], divide(forward_reaction_1, equilibrium_constant_1));
        double equilibrium_constant_2 = multiply(exp_gen(-gibbs_reactions[2]), double(1.0));
        double rate_of_progress_2 = multiply(species[3] * species[4], forward_reaction_2) - multiply(species[2] * species[6], divide(forward_reaction_2, equilibrium_constant_2));
        double equilibrium_constant_3 = multiply(exp_gen(-gibbs_reactions[3]), double(1.0));
        double rate_of_progress_3 = multiply(species[3] * species[6], forward_reaction_3) - multiply(species[2] * species[7], divide(forward_reaction_3, equilibrium_constant_3));
        double equilibrium_constant_4 = multiply(exp_gen(-gibbs_reactions[4]), double(1.0));
        double rate_of_progress_4 = multiply(pow_gen2(species[6]), forward_reaction_4) - multiply(species[7] * species[4], divide(forward_reaction_4, equilibrium_constant_4));
        ...
        double rate_of_progress_5 = multiply(species[3], forward_reaction_5) - multiply(pow_gen2(species[2]), divide(forward_reaction_5, equilibrium_constant_5));
        ...
        double rate_of_progress_6 = multiply(pow_gen2(species[4]), forward_reaction_6) - multiply(species[5], divide(forward_reaction_6, equilibrium_constant_6));
        ...
        double rate_of_progress_7 = multiply(species[2] * species[4], forward_reaction_7) - multiply(species[6], divide(forward_reaction_7, equilibrium_constant_7));
        ...
        double rate_of_progress_8 = multiply(species[7], forward_reaction_8) - multiply(species[2] * species[6], divide(forward_reaction_8, equilibrium_constant_8));
        ...
        double rate_of_progress_9 = multiply(species[7], forward_reaction_9) - multiply(species[2] * species[6], divide(forward_reaction_9, equilibrium_constant_9));
        ...
        double rate_of_progress_10 = multiply(species[2] * species[5], forward_reaction_10) - multiply(species[8], divide(forward_reaction_10, equilibrium_constant_10));
        double equilibrium_constant_11 = multiply(exp_gen(-gibbs_reactions[11]), double(1.0));
        double rate_of_progress_11 = multiply(species[2] * species[8], forward_reaction_11) - multiply(species[3] * species[5], divide(forward_reaction_11, equilibrium_constant_11));
        double equilibrium_constant_12 = multiply(exp_gen(-gibbs_reactions[12]), double(1.0));
        double rate_of_progress_12 = multiply(species[2] * species[8], forward_reaction_12) - multiply(pow_gen2(species[6]), divide(forward_reaction_12, equilibrium_constant_12));
        double equilibrium_constant_13 = multiply(exp_gen(-gibbs_reactions[13]), double(1.0));
        double rate_of_progress_13 = multiply(species[2] * species[8], forward_reaction_13) - multiply(species[7] * species[4], divide(forward_reaction_13, equilibrium_constant_13));
        double equilibrium_constant_14 = multiply(exp_gen(-gibbs_reactions[14]), double(1.0));
        double rate_of_progress_14 = multiply(species[8] * species[4], forward_reaction_14) - multiply(species[5] * species[6], divide(forward_reaction_14, equilibrium_constant_14));
        double equilibrium_constant_15 = multiply(exp_gen(-gibbs_reactions[15]), double(1.0));
        double rate_of_progress_15 = multiply(species[8] * species[6], forward_reaction_15) - multiply(species[7] * species[5], divide(forward_reaction_15, equilibrium_constant_15));
        double equilibrium_constant_16 = multiply(exp_gen(-gibbs_reactions[16]), double(1.0));
        double rate_of_progress_16 = multiply(species[8] * species[6], forward_reaction_16) - multiply(species[7] * species[5], divide(forward_reaction_16, equilibrium_constant_16));
        double equilibrium_constant_17 = multiply(exp_gen(-gibbs_reactions[17]), double(1.0));
        double rate_of_progress_17 = multiply(pow_gen2(species[8]), forward_reaction_17) - multiply(species[9] * species[5], divide(forward_reaction_17, equilibrium_constant_17));
        double equilibrium_constant_18 = multiply(exp_gen(-gibbs_reactions[18]), double(1.0));
        double rate_of_progress_18 = multiply(pow_gen2(species[8]), forward_reaction_18) - multiply(species[9] * species[5], divide(forward_reaction_18, equilibrium_constant_18));
        ...
        double rate_of_progress_19 = multiply(species[9], forward_reaction_19) - multiply(pow_gen2(species[6]), divide(forward_reaction_19, equilibrium_constant_19));
        double equilibrium_constant_20 = multiply(exp_gen(-gibbs_reactions[20]), double(1.0));
        double rate_of_progress_20 = multiply(species[2] * species[9], forward_reaction_20) - multiply(species[7] * species[6], divide(forward_reaction_20, equilibrium_constant_20));
        double equilibrium_constant_21 = multiply(exp_gen(-gibbs_reactions[21]), double(1.0));
        double rate_of_progress_21 = multiply(species[2] * species[9], forward_reaction_21) - multiply(species[3] * species[8], divide(forward_reaction_21, equilibrium_constant_21));
        double equilibrium_constant_22 = multiply(exp_gen(-gibbs_reactions[22]), double(1.0));
        double rate_of_progress_22 = multiply(species[9] * species[4], forward_reaction_22) - multiply(species[8] * species[6], divide(forward_reaction_22, equilibrium_constant_22));
        double equilibrium_constant_23 = multiply(exp_gen(-gibbs_reactions[23]), double(1.0));
        double rate_of_progress_23 = multiply(species[9] * species[6], forward_reaction_23) - multiply(species[7] * species[8], divide(forward_reaction_23, equilibrium_constant_23));
        double equilibrium_constant_24 = multiply(exp_gen(-gibbs_reactions[24]), double(1.0));
        double rate_of_progress_24 = multiply(species[9] * species[6], forward_reaction_24) - multiply(species[7] * species[8], divide(forward_reaction_24, equilibrium_constant_24));
        double equilibrium_constant_25 = multiply(exp_gen(-gibbs_reactions[25]), pressure_atmosphere() * inv_universal_gas_constant_temperature);
        double rate_of_progress_25 = multiply(species[0], forward_reaction_25) - multiply(species[4] * species[5], divide(forward_reaction_25, equilibrium_constant_25));
        double equilibrium_constant_26 = multiply(exp_gen(-gibbs_reactions[26]), double(1.0));
        double rate_of_progress_26 = multiply(species[4] * species[0], forward_reaction_26) - multiply(pow_gen2(species[5]), divide(forward_reaction_26, equilibrium_constant_26));
        double equilibrium_constant_27 = multiply(exp_gen(-gibbs_reactions[27]), double(1.0));
        double rate_of_progress_27 = multiply(species[2] * species[0], forward_reaction_27) - multiply(species[5] * species[6], divide(forward_reaction_27, equilibrium_constant_27));
        double equilibrium_constant_28 = multiply(exp_gen(-gibbs_reactions[28]), double(1.0));
        double rate_of_progress_28 = multiply(species[2] * species[0], forward_reaction_28) - multiply(species[8] * species[4], divide(forward_reaction_28, equilibrium_constant_28));
        double equilibrium_constant_29 = multiply(exp_gen(-gibbs_reactions[29]), double(1.0));
        double rate_of_progress_29 = multiply(species[0] * species[6], forward_reaction_29) - multiply(species[8] * species[5], divide(forward_reaction_29, equilibrium_constant_29));
        double equilibrium_constant_30 = multiply(exp_gen(-gibbs_reactions[30]), double(1.0));
        double rate_of_progress_30 = multiply(species[7] * species[0], forward_reaction_30) - multiply(species[9] * species[5], divide(forward_reaction_30, equilibrium_constant_30));
        double equilibrium_constant_31 = multiply(exp_gen(-gibbs_reactions[31]), pressure_atmosphere() * inv_universal_gas_constant_temperature);
        double rate_of_progress_31 = multiply(species[8] * species[0], forward_reaction_31) - multiply(pow_gen2(species[5]) * species[6], divide(forward_reaction_31, equilibrium_constant_31));

        net_production_rates[0] = double(-1.0) * rate_of_progress_25 + double(-1.0) * rate_of_progress_26 + double(-1.0) * rate_of_progress_27 + double(-1.0) * rate_of_progress_28 + double(-1.0) * rate_of_progress_29 + double(-1.0) * rate_of_progress_30 + double(-1.0) * rate_of_progress_31;
        //source_1 has no production term
        net_production_rates[2] = double(-1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_1 + double(1.0) * rate_of_progress_2 + double(1.0) * rate_of_progress_3 + double(2.0) * rate_of_progress_5 + double(-1.0) * rate_of_progress_7 + double(1.0) * rate_of_progress_8 + double(1.0) * rate_of_progress_9 + double(-1.0) * rate_of_progress_10 + double(-1.0) * rate_of_progress_11 + double(-1.0) * rate_of_progress_12 + double(-1.0) * rate_of_progress_13 + double(-1.0) * rate_of_progress_20 + double(-1.0) * rate_of_progress_21 + double(-1.0) * rate_of_progress_27 + double(-1.0) * rate_of_progress_28;
        net_production_rates[3] = double(-1.0) * rate_of_progress_1 + double(-1.0) * rate_of_progress_2 + double(-1.0) * rate_of_progress_3 + double(-1.0) * rate_of_progress_5 + double(1.0) * rate_of_progress_11 + double(1.0) * rate_of_progress_21;
        net_production_rates[4] = double(1.0) * rate_of_progress_0 + double(-1.0) * rate_of_progress_1 + double(-1.0) * rate_of_progress_2 + double(1.0) * rate_of_progress_4 + double(-2.0) * rate_of_progress_6 + double(-1.0) * rate_of_progress_7 + double(1.0) * rate_of_progress_13 + double(-1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_22 + double(1.0) * rate_of_progress_25 + double(-1.0) * rate_of_progress_26 + double(1.0) * rate_of_progress_28;
        net_production_rates[5] = double(-1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_6 + double(-1.0) * rate_of_progress_10 + double(1.0) * rate_of_progress_11 + double(1.0) * rate_of_progress_14 + double(1.0) * rate_of_progress_15 + double(1.0) * rate_of_progress_16 + double(1.0) * rate_of_progress_17 + double(1.0) * rate_of_progress_18 + double(1.0) * rate_of_progress_25 + double(2.0) * rate_of_progress_26 + double(1.0) * rate_of_progress_27 + double(1.0) * rate_of_progress_29 + double(1.0) * rate_of_progress_30 + double(2.0) * rate_of_progress_31;
        net_production_rates[6] = double(1.0) * rate_of_progress_0 + double(1.0) * rate_of_progress_1 + double(1.0) * rate_of_progress_2 + double(-1.0) * rate_of_progress_3 + double(-2.0) * rate_of_progress_4 + double(1.0) * rate_of_progress_7 + double(1.0) * rate_of_progress_8 + double(1.0) * rate_of_progress_9 + double(2.0) * rate_of_progress_12 + double(1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_15 + double(-1.0) * rate_of_progress_16 + double(2.0) * rate_of_progress_19 + double(1.0) * rate_of_progress_20 + double(1.0) * rate_of_progress_22 + double(-1.0) * rate_of_progress_23 + double(-1.0) * rate_of_progress_24 + double(1.0) * rate_of_progress_27 + double(-1.0) * rate_of_progress_29 + double(1.0) * rate_of_progress_31;
        net_production_rates[7] = double(1.0) * rate_of_progress_3 + double(1.0) * rate_of_progress_4 + double(-1.0) * rate_of_progress_8 + double(-1.0) * rate_of_progress_9 + double(1.0) * rate_of_progress_13 + double(1.0) * rate_of_progress_15 + double(1.0) * rate_of_progress_16 + double(1.0) * rate_of_progress_20 + double(1.0) * rate_of_progress_23 + double(1.0) * rate_of_progress_24 + double(-1.0) * rate_of_progress_30;
        net_production_rates[8] = double(1.0) * rate_of_progress_10 + double(-1.0) * rate_of_progress_11 + double(-1.0) * rate_of_progress_12 + double(-1.0) * rate_of_progress_13 + double(-1.0) * rate_of_progress_14 + double(-1.0) * rate_of_progress_15 + double(-1.0) * rate_of_progress_16 + double(-2.0) * rate_of_progress_17 + double(-2.0) * rate_of_progress_18 + double(1.0) * rate_of_progress_21 + double(1.0) * rate_of_progress_22 + double(1.0) * rate_of_progress_23 + double(1.0) * rate_of_progress_24 + double(1.0) * rate_of_progress_28 + double(1.0) * rate_of_progress_29 + double(-1.0) * rate_of_progress_31;
        net_production_rates[9] = double(1.0) * rate_of_progress_17 + double(1.0) * rate_of_progress_18 + double(-1.0) * rate_of_progress_19 + double(-1.0) * rate_of_progress_20 + double(-1.0) * rate_of_progress_21 + double(-1.0) * rate_of_progress_22 + double(-1.0) * rate_of_progress_23 + double(-1.0) * rate_of_progress_24 + double(1.0) * rate_of_progress_30;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[5], dforward_reaction_0_dtemperature)
        -
        multiply(species[4] * species[6],
        ...
        dsource_species_dtemperature_[5] += -drate_of_progress_0_dtemperature;
        dsource_species_dtemperature_[4] += drate_of_progress_0_dtemperature;
        dsource_species_dtemperature_[6] += drate_of_progress_0_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[3] * species[4], dforward_reaction_1_dtemperature)
        -
        multiply(species[2] * species[6],
        ...
        dsource_species_dtemperature_[6] += drate_of_progress_1_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[3] * species[4], dforward_reaction_2_dtemperature)
        -
        multiply(species[2] * species[6],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[3] * species[6], dforward_reaction_3_dtemperature)
        -
        multiply(species[2] * species[7],
        ...
        dsource_species_dtemperature_[3] += -drate_of_progress_3_dtemperature;
        dsource_species_dtemperature_[6] += -drate_of_progress_3_dtemperature;
        dsource_species_dtemperature_[2] += drate_of_progress_3_dtemperature;
        dsource_species_dtemperature_[7] += drate_of_progress_3_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[6]), dforward_reaction_4_dtemperature)
        -
        ...
        dsource_species_dtemperature_[7] += drate_of_progress_4_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[3], dforward_reaction_5_dtemperature)
        -
        multiply(pow_gen2(species[2]),
        ...
        dsource_species_dtemperature_[3] += -drate_of_progress_5_dtemperature;
        dsource_species_dtemperature_[2] += 2.0*drate_of_progress_5_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[4]), dforward_reaction_6_dtemperature)
        -
        multiply(species[5],
        ...
        dsource_species_dtemperature_[4] += -2.0*drate_of_progress_6_dtemperature;
        dsource_species_dtemperature_[5] += drate_of_progress_6_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[4], dforward_reaction_7_dtemperature)
        -
        multiply(species[6],
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[7], dforward_reaction_8_dtemperature)
        -
        multiply(species[2] * species[6],
        ...
        dsource_species_dtemperature_[7] += -drate_of_progress_8_dtemperature;
        dsource_species_dtemperature_[2] += drate_of_progress_8_dtemperature;
...
{
                double forward_reaction_9 =  call_forward_reaction_9(species, temperature, log_temperature, species[7]);
        double dforward_reaction_9_dtemperature = dcall_forward_reaction_9_dtemperature(species,temperature,log_temperature,species[7]);


        dforward_reaction_9_dtemperature += dcall_forward_reaction_9_dlog_temperature(species,temperature,log_temperature,species[7]) * dlog_temperature_dtemperature;
        ...
        multiply(species[7], dforward_reaction_9_dtemperature)
        -
        multiply(species[2] * species[6],
        ...
        dsource_species_dtemperature_[7] += -drate_of_progress_9_dtemperature;
        dsource_species_dtemperature_[2] += drate_of_progress_9_dtemperature;
        dsource_species_dtemperature_[6] += drate_of_progress_9_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[5], dforward_reaction_10_dtemperature)
        -
        multiply(species[8],
        ...
        dsource_species_dtemperature_[8] += drate_of_progress_10_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[8], dforward_reaction_11_dtemperature)
        -
        multiply(species[3] * species[5],
        ...
        dsource_species_dtemperature_[2] += -drate_of_progress_11_dtemperature;
        dsource_species_dtemperature_[8] += -drate_of_progress_11_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[8], dforward_reaction_12_dtemperature)
        -
        multiply(pow_gen2(species[6]),
        ...
        dsource_species_dtemperature_[2] += -drate_of_progress_12_dtemperature;
        dsource_species_dtemperature_[8] += -drate_of_progress_12_dtemperature;
        dsource_species_dtemperature_[6] += 2.0*drate_of_progress_12_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[8], dforward_reaction_13_dtemperature)
        -
        multiply(species[7] * species[4],
        ...
        dsource_species_dtemperature_[8] += -drate_of_progress_13_dtemperature;
        dsource_species_dtemperature_[7] += drate_of_progress_13_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[8] * species[4], dforward_reaction_14_dtemperature)
        -
        ...
        dsource_species_dtemperature_[8] += -drate_of_progress_14_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[8] * species[6], dforward_reaction_15_dtemperature)
        -
        ...
        dsource_species_dtemperature_[8] += -drate_of_progress_15_dtemperature;
        dsource_species_dtemperature_[6] += -drate_of_progress_15_dtemperature;
        dsource_species_dtemperature_[7] += drate_of_progress_15_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[8] * species[6], dforward_reaction_16_dtemperature)
        -
        multiply(species[7] * species[5],
        ...
        dsource_species_dtemperature_[8] += -drate_of_progress_16_dtemperature;
        dsource_species_dtemperature_[6] += -drate_of_progress_16_dtemperature;
        dsource_species_dtemperature_[7] += drate_of_progress_16_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[8]), dforward_reaction_17_dtemperature)
        -
        ...
        dsource_species_dtemperature_[8] += -2.0*drate_of_progress_17_dtemperature;
        dsource_species_dtemperature_[9] += drate_of_progress_17_dtemperature;
        dsource_species_dtemperature_[5] += drate_of_progress_17_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(pow_gen2(species[8]), dforward_reaction_18_dtemperature)
        -
        multiply(species[9] * species[5],
        ...
        dsource_species_dtemperature_[8] += -2.0*drate_of_progress_18_dtemperature;
        dsource_species_dtemperature_[9] += drate_of_progress_18_dtemperature;
        dsource_species_dtemperature_[5] += drate_of_progress_18_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[9], dforward_reaction_19_dtemperature)
        -
        multiply(pow_gen2(species[6]),
        ...
        dsource_species_dtemperature_[6] += 2.0*drate_of_progress_19_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[9], dforward_reaction_20_dtemperature)
        -
        ...
        dsource_species_dtemperature_[2] += -drate_of_progress_20_dtemperature;
        ...
        dsource_species_dtemperature_[6] += drate_of_progress_20_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[2] * species[9], dforward_reaction_21_dtemperature)
        -
        multiply(species[3] * species[8],
        ...
        dsource_species_dtemperature_[2] += -drate_of_progress_21_dtemperature;
        dsource_species_dtemperature_[9] += -drate_of_progress_21_dtemperature;
        dsource_species_dtemperature_[3] += drate_of_progress_21_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[9] * species[4], dforward_reaction_22_dtemperature)
        -
        multiply(species[8] * species[6],
        ...
        dsource_species_dtemperature_[9] += -drate_of_progress_22_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[9] * species[6], dforward_reaction_23_dtemperature)
        -
        multiply(species[7] * species[8],
        ...
        dsource_species_dtemperature_[9] += -drate_of_progress_23_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        multiply(species[9] * species[6], dforward_reaction_24_dtemperature)
        -
        multiply(species[7] * species[8],
        ...
        dsource_species_dtemperature_[9] += -drate_of_progress_24_dtemperature;
...
{
                double forward_reaction_25 =  call_forward_reaction_25(species, temperature, log_temperature, mixture_concentration);
        double dforward_reaction_25_dtemperature = dcall_forward_reaction_25_dtemperature(species,temperature,log_temperature,mixture_concentration);


        dforward_reaction_25_dtemperature += dcall_forward_reaction_25_dlog_temperature(species,temperature,log_temperature,mixture_concentration) * dlog_temperature_dtemperature;


        

        // Reaction 25: O3 (+M) <=> O + O2 (+M)

        double drate_of_progress_25_dtemperature =
        multiply(species[0], dforward_reaction_25_dtemperature)
        -
        multiply(species[4] * species[5],
        ...
        dsource_species_dtemperature_[0] += -drate_of_progress_25_dtemperature;
        dsource_species_dtemperature_[4] += drate_of_progress_25_dtemperature;
        dsource_species_dtemperature_[5] += drate_of_progress_25_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 26: O + O3 <=> 2 O2

        double drate_of_progress_26_dtemperature =
        multiply(species[4] * species[0], dforward_reaction_26_dtemperature)
        -
        multiply(pow_gen2(species[5]),
        ...
        dsource_species_dtemperature_[5] += 2.0*drate_of_progress_26_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 27: H + O3 <=> O2 + OH

        double drate_of_progress_27_dtemperature =
        multiply(species[2] * species[0], dforward_reaction_27_dtemperature)
        -
        multiply(species[5] * species[6],
        ...
        dsource_species_dtemperature_[0] += -drate_of_progress_27_dtemperature;
        ...
        void update_dsource_species_dtemperature_reaction_28(Species& dsource_species_dtemperature_,
                                                           ...
                                                           const double& mixture_concentration,
                                                           const double& pressure_,
                                                           const double& equilibrium_constant_28,
                                                           const double& dequilibrium_constant_28_dtemperature,
                                                           const double& dlog_temperature_dtemperature)
{
                double forward_reaction_28 = call_forward_reaction_28(temperature, log_temperature);
        ...
        // Reaction 28: H + O3 <=> HO2 + O

        double drate_of_progress_28_dtemperature =
        multiply(species[2] * species[0], dforward_reaction_28_dtemperature)
        -
        multiply(species[8] * species[4],
                 divide_chain(forward_reaction_28,
                              dforward_reaction_28_dtemperature,
                              equilibrium_constant_28,
                              dequilibrium_constant_28_dtemperature));

        dsource_species_dtemperature_[2] += -drate_of_progress_28_dtemperature;
        dsource_species_dtemperature_[0] += -drate_of_progress_28_dtemperature;
        dsource_species_dtemperature_[8] += drate_of_progress_28_dtemperature;
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 29: O3 + OH <=> HO2 + O2

        double drate_of_progress_29_dtemperature =
        multiply(species[0] * species[6], dforward_reaction_29_dtemperature)
        -
        ...
        dsource_species_dtemperature_[0] += -drate_of_progress_29_dtemperature;
        dsource_species_dtemperature_[6] += -drate_of_progress_29_dtemperature;
        dsource_species_dtemperature_[8] += drate_of_progress_29_dtemperature;
        dsource_species_dtemperature_[5] += drate_of_progress_29_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 30: H2O + O3 <=> H2O2 + O2

        double drate_of_progress_30_dtemperature =
        multiply(species[7] * species[0], dforward_reaction_30_dtemperature)
        -
        multiply(species[9] * species[5],
        ...
        dsource_species_dtemperature_[0] += -drate_of_progress_30_dtemperature;
        dsource_species_dtemperature_[9] += drate_of_progress_30_dtemperature;
        dsource_species_dtemperature_[5] += drate_of_progress_30_dtemperature;
}
                                                           ...
                                                           const double& dlog_temperature_dtemperature)
{
        ...
        // Reaction 31: HO2 + O3 <=> 2 O2 + OH

        double drate_of_progress_31_dtemperature =
        multiply(species[8] * species[0], dforward_reaction_31_dtemperature)
        -
        multiply(pow_gen2(species[5]) * species[6],
        ...
        dsource_species_dtemperature_[5] += 2.0*drate_of_progress_31_dtemperature;
        dsource_species_dtemperature_[6] += drate_of_progress_31_dtemperature;
}
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[5], forward_reaction_0); // [0][2] +
        ...
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_0); // [0][5] +
        ...
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_0, equilibrium_constant_0));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_1); // [1][3] +
        ...
        drate_of_progress_dspecies = multiply(species[3], forward_reaction_1); // [1][4] +
        jacobian_net_production_rates[4][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_1, equilibrium_constant_1));
        jacobian_net_production_rates[4][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[2], divide(forward_reaction_1, equilibrium_constant_1));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_2); // [2][3] +
        jacobian_net_production_rates[4][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[3], forward_reaction_2); // [2][4] +
        jacobian_net_production_rates[4][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_2, equilibrium_constant_2));
        jacobian_net_production_rates[4][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[2], divide(forward_reaction_2, equilibrium_constant_2));
        jacobian_net_production_rates[4][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[6], forward_reaction_3); // [3][3] +
        jacobian_net_production_rates[4][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[3], forward_reaction_3); // [3][6] +
        jacobian_net_production_rates[4][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_3, equilibrium_constant_3));
        jacobian_net_production_rates[4][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[8][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[2], divide(forward_reaction_3, equilibrium_constant_3));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[6]), forward_reaction_4); // [4][6] +
        jacobian_net_production_rates[7][7] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_4, equilibrium_constant_4));
        ...
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_4, equilibrium_constant_4));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_5;// 5 3 
        jacobian_net_production_rates[4][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][4] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[2]), divide(forward_reaction_5, equilibrium_constant_5));// 5 2
        jacobian_net_production_rates[4][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][3] += 2.0*drate_of_progress_dspecies;


        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[3] - divide(pow_gen2(species[2]), equilibrium_constant_5),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[4]), forward_reaction_6);//6 4
        jacobian_net_production_rates[5][5] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[6][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_6, equilibrium_constant_6); //6 5
        jacobian_net_production_rates[5][6] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;


        Species drate_of_progress_dspecies_all_species =
        scale_gen(pow_gen2(species[4]) - divide(species[5], equilibrium_constant_6),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_7);//7 2
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_7);//7 4
        jacobian_net_production_rates[3][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_7, equilibrium_constant_7); //7 6
        jacobian_net_production_rates[3][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[2] * species[4] - divide(species[6], equilibrium_constant_7),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_8;// 8 7 
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_8, equilibrium_constant_8));// 8 2
        jacobian_net_production_rates[8][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[2], divide(forward_reaction_8, equilibrium_constant_8));// 8 6
        jacobian_net_production_rates[8][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[7] - divide(species[2] * species[6], equilibrium_constant_8),
                                               ...
                                               const double& dlog_temperature_dtemperature)
{
        ...
        Species dforward_reaction_9_dspecies = dcall_forward_reaction_9_dspecies(species,temperature,log_temperature,species[7]);
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_9;// 9 7 
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_9, equilibrium_constant_9));// 9 2
        jacobian_net_production_rates[8][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[2], divide(forward_reaction_9, equilibrium_constant_9));// 9 6
        jacobian_net_production_rates[8][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[3][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[7] - divide(species[2] * species[6], equilibrium_constant_9),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[5], forward_reaction_10);//10 2
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_10);//10 5
        jacobian_net_production_rates[3][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -divide(forward_reaction_10, equilibrium_constant_10); //10 8
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[2] * species[5] - divide(species[8], equilibrium_constant_10),
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_11); // [11][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_11); // [11][8] +
        jacobian_net_production_rates[3][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_11, equilibrium_constant_11));
        jacobian_net_production_rates[3][4] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_12); // [12][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_12); // [12][8] +
        jacobian_net_production_rates[3][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[6]), divide(forward_reaction_12, equilibrium_constant_12));
        jacobian_net_production_rates[3][7] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_13); // [13][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_13); // [13][8] +
        jacobian_net_production_rates[3][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][9] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_13, equilibrium_constant_13));
        jacobian_net_production_rates[3][5] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_14); // [14][4] +
        jacobian_net_production_rates[9][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_14); // [14][8] +
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += drate_of_progress_dspecies;
        ...
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_14, equilibrium_constant_14));
        jacobian_net_production_rates[9][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_15); // [15][6] +
        jacobian_net_production_rates[9][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[6], forward_reaction_15); // [15][8] +
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_15, equilibrium_constant_15));
        jacobian_net_production_rates[9][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_16); // [16][6] +
        jacobian_net_production_rates[9][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[6], forward_reaction_16); // [16][8] +
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_16, equilibrium_constant_16));
        jacobian_net_production_rates[9][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[8]), forward_reaction_17); // [17][8] +
        ...
        jacobian_net_production_rates[6][9] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[9], divide(forward_reaction_17, equilibrium_constant_17));
        jacobian_net_production_rates[9][6] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[10][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_17, equilibrium_constant_17));
        jacobian_net_production_rates[9][10] += -2.0*drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(dpow_gen2_da(species[8]), forward_reaction_18); // [18][8] +
        jacobian_net_production_rates[9][9] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[10][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[9], divide(forward_reaction_18, equilibrium_constant_18));
        jacobian_net_production_rates[9][6] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[10][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_18, equilibrium_constant_18));
        jacobian_net_production_rates[9][10] += -2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[10][10] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][10] += drate_of_progress_dspecies;
}
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_19;// 19 9 
        jacobian_net_production_rates[10][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][10] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[6]), divide(forward_reaction_19, equilibrium_constant_19));// 19 6
        jacobian_net_production_rates[10][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += 2.0*drate_of_progress_dspecies;


        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[9] - divide(pow_gen2(species[6]), equilibrium_constant_19),
        ...
        jacobian_net_production_rates[7] = add_species_to_chemical_state(jacobian_net_production_rates[7], scale_gen(2.0, drate_of_progress_dspecies_all_species));
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[9], forward_reaction_20); // [20][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_20); // [20][9] +
        ...
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_20, equilibrium_constant_20));
        jacobian_net_production_rates[3][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[6], divide(forward_reaction_20, equilibrium_constant_20));
        jacobian_net_production_rates[3][8] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[9], forward_reaction_21); // [21][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_21); // [21][9] +
        jacobian_net_production_rates[3][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][10] += -drate_of_progress_dspecies;
        ...
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_21, equilibrium_constant_21));
        jacobian_net_production_rates[3][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][4] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][4] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][4] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[3], divide(forward_reaction_21, equilibrium_constant_21));
        jacobian_net_production_rates[3][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[4][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][9] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[9], forward_reaction_22); // [22][4] +
        jacobian_net_production_rates[10][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_22); // [22][9] +
        jacobian_net_production_rates[10][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][10] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][10] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_22, equilibrium_constant_22));
        jacobian_net_production_rates[10][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[9], forward_reaction_23); // [23][6] +
        jacobian_net_production_rates[10][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[6], forward_reaction_23); // [23][9] +
        jacobian_net_production_rates[10][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][10] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][10] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_23, equilibrium_constant_23));
        jacobian_net_production_rates[10][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][8] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[9], forward_reaction_24); // [24][6] +
        jacobian_net_production_rates[10][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[6], forward_reaction_24); // [24][9] +
        jacobian_net_production_rates[10][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][10] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][10] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][10] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_24, equilibrium_constant_24));
        jacobian_net_production_rates[10][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[7], divide(forward_reaction_24, equilibrium_constant_24));
        jacobian_net_production_rates[10][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[8][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[9][9] += drate_of_progress_dspecies;
                                               ...
                                               const double& dlog_temperature_dtemperature)
{
        ...
        Species dforward_reaction_25_dspecies = dcall_forward_reaction_25_dspecies(species,temperature,log_temperature,mixture_concentration);
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = forward_reaction_25;// 25 0 
        ...
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_25, equilibrium_constant_25));// 25 4
        jacobian_net_production_rates[1][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_25, equilibrium_constant_25));// 25 5
        ...
        Species drate_of_progress_dspecies_all_species =
        scale_gen(species[0] - divide(species[4] * species[5], equilibrium_constant_25),
                  dforward_reaction_25_dspecies);
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[4], forward_reaction_26); // [26][0] +
        jacobian_net_production_rates[5][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][1] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[0], forward_reaction_26); // [26][4] +
        jacobian_net_production_rates[5][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][5] += 2.0*drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[5]), divide(forward_reaction_26, equilibrium_constant_26));
        jacobian_net_production_rates[5][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][6] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_27); // [27][0] +
        jacobian_net_production_rates[3][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][1] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][1] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[0], forward_reaction_27); // [27][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        ...
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_27, equilibrium_constant_27));
        jacobian_net_production_rates[3][7] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[2], forward_reaction_28); // [28][0] +
        jacobian_net_production_rates[3][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][1] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][1] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[0], forward_reaction_28); // [28][2] +
        jacobian_net_production_rates[3][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][3] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][3] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][3] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_28, equilibrium_constant_28));
        jacobian_net_production_rates[3][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][5] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][5] += drate_of_progress_dspecies;
        jacobian_net_production_rates[5][5] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[4], divide(forward_reaction_28, equilibrium_constant_28));
        jacobian_net_production_rates[3][9] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[6], forward_reaction_29); // [29][0] +
        jacobian_net_production_rates[1][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][1] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][1] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[0], forward_reaction_29); // [29][6] +
        jacobian_net_production_rates[1][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][7] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][7] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[8], divide(forward_reaction_29, equilibrium_constant_29));
        jacobian_net_production_rates[1][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_29, equilibrium_constant_29));
        jacobian_net_production_rates[1][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[9][9] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[7], forward_reaction_30); // [30][0] +
        ...
        jacobian_net_production_rates[6][1] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[0], forward_reaction_30); // [30][7] +
        jacobian_net_production_rates[8][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][8] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][8] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][8] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[9], divide(forward_reaction_30, equilibrium_constant_30));
        jacobian_net_production_rates[8][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[10][6] += drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(species[5], divide(forward_reaction_30, equilibrium_constant_30));
        jacobian_net_production_rates[8][10] += -drate_of_progress_dspecies;
...
double drate_of_progress_dspecies  = double(0);
        ...
        drate_of_progress_dspecies = multiply(species[8], forward_reaction_31); // [31][0] +
        jacobian_net_production_rates[9][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][1] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][1] += 2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[7][1] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = multiply(species[0], forward_reaction_31); // [31][8] +
        jacobian_net_production_rates[9][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][9] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][9] += 2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[7][9] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(dpow_gen2_da(species[5]) * species[6], divide(forward_reaction_31, equilibrium_constant_31));
        jacobian_net_production_rates[9][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][6] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[6][6] += 2.0*drate_of_progress_dspecies;
        jacobian_net_production_rates[7][6] += drate_of_progress_dspecies;
        drate_of_progress_dspecies = -multiply(pow_gen2(species[5]), divide(forward_reaction_31, equilibrium_constant_31));
        jacobian_net_production_rates[9][7] += -drate_of_progress_dspecies;
        jacobian_net_production_rates[1][7] += -drate_of_progress_dspecies;
    ...
    SpeciesJacobian source_jacobian(const Species& species, const double& temperature)  
    {
        ...
        double equilibrium_constant_28 = multiply(exp_gen(-gibbs_reactions[28]), double(1.0));
        double dequilibrium_constant_28_dtemperature = 
        multiply_chain(exp_gen(-gibbs_reactions[28]), 
                       exp_chain(-gibbs_reactions[28], 
                                 -dgibbs_reactions_dlog_temperature[28]) * dlog_temperature_dtemperature, 
                       double(1.0), 
                       double(0.0));
        ...
        update_jacobian_reaction_28(jacobian_net_production_rates, species, temperature, log_temperature, mixture_concentration, pressure_, dtemperature_dspecies_, equilibrium_constant_28, dequilibrium_constant_28_dtemperature,dlog_temperature_dtemperature); 
        ...
        update_dsource_species_dtemperature_reaction_28(dsource_species_dtemperature_, species, temperature, log_temperature, mixture_concentration, pressure_, equilibrium_constant_28, dequilibrium_constant_28_dtemperature,dlog_temperature_dtemperature); 
