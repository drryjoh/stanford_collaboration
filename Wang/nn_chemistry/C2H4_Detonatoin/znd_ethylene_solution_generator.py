...
gas1 = ct.Solution('./transport_23_species/ffcmy9reduced_lean23.yaml')
gas1.TPX = T, P, X
print(gas1.density)
...
cj_speed, R2, plot_data = CJspeed(P, T, X, './transport_23_species/ffcmy9reduced_lean23.yaml', fullOutput=True)

gas = PostShock_fr(cj_speed, P, T, X, './transport_23_species/ffcmy9reduced_lean23.yaml')
