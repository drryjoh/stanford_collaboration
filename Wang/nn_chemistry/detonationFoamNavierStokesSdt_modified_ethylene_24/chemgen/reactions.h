...
double call_forward_reaction_22(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return third_body(double(480000000000000.06), double(-1.2), double(74199056.0), temperature, log_temperature, mixture_concentration + (double(12.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
...
double
call_forward_reaction_32(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(2.4300000000000004e+16), double(-1.6), double(0.0), double(51300000000.00001), double(0.15), double(0.0), double(0.514), double(22850.0), double(10350.0), double(152.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
...
double
call_forward_reaction_38(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(3.2600000000000005e+18), double(-2.5), double(0.0), double(1020000000000.0001), double(-0.4), double(0.0), double(0.4), double(90000.0), double(90000.0), double(30.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
...
double
call_forward_reaction_40(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(1.3900000000000004e+28), double(-5.04), double(30961600.0), double(21300000000.000004), double(0.32), double(0.0), double(0.405), double(2811.0), double(9908.0), double(258.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
...
double call_forward_reaction_53(const double& temperature, const double& log_temperature)  { return arrhenius(double(12000000000.000002), double(0.0), double(1970664.0), temperature, log_temperature);}
    
double call_forward_reaction_54(const double& temperature, const double& log_temperature)  { return arrhenius(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
...
double call_forward_reaction_57(const double& temperature, const double& log_temperature)  { return arrhenius(double(68000000000.000015), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_58(const double& temperature, const double& log_temperature)  { return arrhenius(double(31300000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_59(const double& temperature, const double& log_temperature)  { return arrhenius(double(15100000000.000002), double(0.0), double(-1803304.0), temperature, log_temperature);}
    

double
call_forward_reaction_60(const double& temperature, const double& pressure) 
{
...
double call_forward_reaction_61(const double& temperature, const double& log_temperature)  { return arrhenius(double(9000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_62(const double& temperature, const double& log_temperature)  { return arrhenius(double(13300000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_63(const double& temperature, const double& log_temperature)  { return arrhenius(double(6620000000.000001), double(0.0), double(0.0), temperature, log_temperature);}
    
double
call_forward_reaction_64(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(4.190000000000001e+28), double(-5.533), double(25639552.0), double(186000000000.00003), double(-0.033), double(-594128.0), double(0.782), double(2755.0), double(6570.0), double(271.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
call_forward_reaction_65(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(4.4000000000000005e+35), double(-6.1), double(393295999.99999994), double(37000000000000.0), double(0.0), double(301147584.0), double(0.932), double(1540.0), double(10300.0), double(197.00000000000003), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double call_forward_reaction_66(const double& temperature, const double& log_temperature)  { return arrhenius(double(5670000000.000001), double(0.361), double(19284056.0), temperature, log_temperature);}
    
double call_forward_reaction_67(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return third_body(double(11400000000.000002), double(0.582), double(60228680.0), temperature, log_temperature, mixture_concentration);}
    
double call_forward_reaction_68(const double& temperature, const double& log_temperature)  { return arrhenius(double(416000000.00000006), double(0.57), double(11556208.0), temperature, log_temperature);}
    
double call_forward_reaction_69(const double& temperature, const double& log_temperature)  { return arrhenius(double(78200.00000000001), double(1.63), double(-4414120.0), temperature, log_temperature);}
    
double call_forward_reaction_70(const double& temperature, const double& log_temperature)  { return arrhenius(double(244.00000000000006), double(2.5), double(152548640.0), temperature, log_temperature);}
    
double call_forward_reaction_71(const double& temperature, const double& log_temperature)  { return arrhenius(double(96400000000.00002), double(0.0), double(-2163128.0), temperature, log_temperature);}
    
double call_forward_reaction_72(const double& temperature, const double& log_temperature)  { return arrhenius(double(7.400000000000001e-05), double(4.21), double(4686080.0), temperature, log_temperature);}
    
double call_forward_reaction_73(const double& temperature, const double& log_temperature)  { return arrhenius(double(13300000000.000002), double(0.0), double(-2301200.0), temperature, log_temperature);}
    
double call_forward_reaction_74(const double& temperature, const double& log_temperature)  { return arrhenius(double(5.400000000000001), double(2.81), double(24526608.0), temperature, log_temperature);}
    
double
call_forward_reaction_75(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(1.27e+30), double(-5.57), double(15974512.0), double(211000000000.00003), double(0.0), double(0.0), double(0.37), double(61.0), double(90000.0), double(3315.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double call_forward_reaction_76(const double& temperature, const double& log_temperature)  { return arrhenius(double(53900000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_77(const double& temperature, const double& log_temperature)  { return arrhenius(double(23100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_78(const double& temperature, const double& log_temperature)  { return arrhenius(double(42.900000000000006), double(2.57), double(16727632.0), temperature, log_temperature);}
    

double
call_forward_reaction_79(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_80(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double call_forward_reaction_81(const double& temperature, const double& log_temperature)  { return arrhenius(double(116.00000000000001), double(2.228), double(-12644048.0), temperature, log_temperature);}
    
double call_forward_reaction_82(const double& temperature, const double& log_temperature)  { return arrhenius(double(10400000000.000002), double(0.0), double(-2468560.0), temperature, log_temperature);}
    
double call_forward_reaction_83(const double& temperature, const double& log_temperature)  { return arrhenius(double(7550000000.000001), double(0.0), double(118394648.0), temperature, log_temperature);}
    
double call_forward_reaction_84(const double& temperature, const double& log_temperature)  { return arrhenius(double(0.0686), double(2.86), double(40869312.0), temperature, log_temperature);}
    
double call_forward_reaction_85(const double& temperature, const double& log_temperature)  { return arrhenius(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_86(const double& temperature, const double& log_temperature)  { return arrhenius(double(72300000000.00002), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_87(const double& temperature, const double& log_temperature)  { return arrhenius(double(14000000000.000002), double(0.0), double(-2079448.0), temperature, log_temperature);}
    
double call_forward_reaction_88(const double& temperature, const double& log_temperature)  { return arrhenius(double(26200000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_89(const double& temperature, const double& log_temperature)  { return arrhenius(double(0.031900000000000005), double(3.36), double(18033040.0), temperature, log_temperature);}
    
double
call_forward_reaction_90(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(60200000000000.01), double(-0.5468), double(75412416.0), double(11300000000.0), double(1.21), double(100729800.0), double(0.341), double(1000.0), double(2339.0), double(28.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double call_forward_reaction_91(const double& temperature, const double& log_temperature)  { return arrhenius(double(37900000000.00001), double(0.0), double(2493664.0), temperature, log_temperature);}
    
double call_forward_reaction_92(const double& temperature, const double& log_temperature)  { return arrhenius(double(388000000000.00006), double(-0.264), double(-108784.0), temperature, log_temperature);}
    
double call_forward_reaction_93(const double& temperature, const double& log_temperature)  { return arrhenius(double(197000000.00000003), double(0.414), double(1016712.0), temperature, log_temperature);}
    
double call_forward_reaction_94(const double& temperature, const double& log_temperature)  { return arrhenius(double(3780000000.0000005), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_95(const double& temperature, const double& log_temperature)  { return arrhenius(double(18100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_96(const double& temperature, const double& log_temperature)  { return arrhenius(double(63200000.00000001), double(0.0), double(10890952.0), temperature, log_temperature);}
    
double call_forward_reaction_97(const double& temperature, const double& log_temperature)  { return arrhenius(double(24000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_98(const double& temperature, const double& log_temperature)  { return arrhenius(double(6000000000.000001), double(0.0), double(46024000.0), temperature, log_temperature);}
    
double call_forward_reaction_99(const double& temperature, const double& log_temperature)  { return arrhenius(double(614.0000000000001), double(2.5), double(40116192.0), temperature, log_temperature);}
    
double call_forward_reaction_100(const double& temperature, const double& log_temperature)  { return arrhenius(double(693000.0000000001), double(1.56), double(35501240.0), temperature, log_temperature);}
    
double call_forward_reaction_101(const double& temperature, const double& log_temperature)  { return arrhenius(double(1000.0000000000002), double(2.182), double(10234064.0), temperature, log_temperature);}
    
double call_forward_reaction_102(const double& temperature, const double& log_temperature)  { return arrhenius(double(30000000000.000004), double(0.0), double(-1661048.0), temperature, log_temperature);}
    
double call_forward_reaction_103(const double& temperature, const double& log_temperature)  { return arrhenius(double(2460.0000000000005), double(2.0), double(34601680.0), temperature, log_temperature);}
    
double call_forward_reaction_104(const double& temperature, const double& log_temperature)  { return arrhenius(double(18700000000.000004), double(0.0), double(-2079448.0), temperature, log_temperature);}
    
double call_forward_reaction_105(const double& temperature, const double& log_temperature)  { return arrhenius(double(132000000000.00002), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_106(const double& temperature, const double& log_temperature)  { return arrhenius(double(173000000000.00003), double(-0.112), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_107(const double& temperature, const double& log_temperature)  { return arrhenius(double(29500000000.000004), double(0.0), double(4656792.0), temperature, log_temperature);}
    
double call_forward_reaction_108(const double& temperature, const double& log_temperature)  { return arrhenius(double(1630000000.0000002), double(0.0), double(3573136.0), temperature, log_temperature);}
    
double call_forward_reaction_109(const double& temperature, const double& log_temperature)  { return arrhenius(double(18800000000000.004), double(-0.59), double(606680.0), temperature, log_temperature);}
    
double call_forward_reaction_110(const double& temperature, const double& log_temperature)  { return arrhenius(double(37900000000.00001), double(0.13), double(-899560.0), temperature, log_temperature);}
    
double call_forward_reaction_111(const double& temperature, const double& log_temperature)  { return arrhenius(double(50000000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_112(const double& temperature, const double& log_temperature)  { return arrhenius(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_113(const double& temperature, const double& log_temperature)  { return arrhenius(double(10000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double
call_forward_reaction_114(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(3.6300000000000005e+21), double(-3.38), double(3543848.0), double(554000.0000000001), double(1.64), double(8769664.0), double(0.215), double(1043.0), double(2341.0), double(10.7), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double call_forward_reaction_115(const double& temperature, const double& log_temperature)  { return arrhenius(double(939000.0000000001), double(1.4), double(9229904.0), temperature, log_temperature);}
    
double call_forward_reaction_116(const double& temperature, const double& log_temperature)  { return arrhenius(double(235000.00000000003), double(1.4), double(9229904.0), temperature, log_temperature);}
    

double
call_forward_reaction_117(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_118(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double call_forward_reaction_119(const double& temperature, const double& log_temperature)  { return arrhenius(double(7750.000000000001), double(1.605), double(64015200.0), temperature, log_temperature);}
    
double call_forward_reaction_120(const double& temperature, const double& log_temperature)  { return arrhenius(double(23200.000000000004), double(1.605), double(64015200.0), temperature, log_temperature);}
    
double
call_forward_reaction_121(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(2.6900000000000006e+27), double(-5.11), double(29685480.0), double(810000000.0000001), double(0.5), double(18869840.0), double(0.591), double(1226.0), double(5185.0), double(275.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double call_forward_reaction_122(const double& temperature, const double& log_temperature)  { return arrhenius(double(42000.00000000001), double(1.9), double(49580400.0), temperature, log_temperature);}
    
double call_forward_reaction_123(const double& temperature, const double& log_temperature)  { return arrhenius(double(777000.0000000001), double(1.45), double(11631520.0), temperature, log_temperature);}
    
double call_forward_reaction_124(const double& temperature, const double& log_temperature)  { return arrhenius(double(10000000000.000002), double(0.0), double(43095200.0), temperature, log_temperature);}
    
double call_forward_reaction_125(const double& temperature, const double& log_temperature)  { return arrhenius(double(1080000000.0000002), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double call_forward_reaction_126(const double& temperature, const double& log_temperature)  { return arrhenius(double(361000000.00000006), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double call_forward_reaction_127(const double& temperature, const double& log_temperature)  { return arrhenius(double(361000000.00000006), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double call_forward_reaction_128(const double& temperature, const double& log_temperature)  { return arrhenius(double(11.200000000000001), double(2.74), double(9288480.0), temperature, log_temperature);}
    
double call_forward_reaction_129(const double& temperature, const double& log_temperature)  { return arrhenius(double(680000000.0000001), double(0.0), double(-4238392.0), temperature, log_temperature);}
    
double call_forward_reaction_130(const double& temperature, const double& log_temperature)  { return arrhenius(double(1010000000.0000001), double(0.0), double(-4238392.0), temperature, log_temperature);}
    
double call_forward_reaction_131(const double& temperature, const double& log_temperature)  { return arrhenius(double(145000000000.00003), double(0.0), double(0.0), temperature, log_temperature);}
    
double
call_forward_reaction_132(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(1.4000000000000004e+24), double(-3.86), double(13890880.0), double(38800000000.00001), double(0.2), double(0.0), double(0.782), double(2663.0), double(6095.0), double(207.49999999999997), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double call_forward_reaction_133(const double& temperature, const double& log_temperature)  { return arrhenius(double(1210000000.0000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_134(const double& temperature, const double& log_temperature)  { return arrhenius(double(30100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_135(const double& temperature, const double& log_temperature)  { return arrhenius(double(21000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_136(const double& temperature, const double& log_temperature)  { return arrhenius(double(16700000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_137(const double& temperature, const double& log_temperature)  { return arrhenius(double(1140000000.0000002), double(0.0), double(5857599.999999999), temperature, log_temperature);}
    
double call_forward_reaction_138(const double& temperature, const double& log_temperature)  { return arrhenius(double(41800000000.00001), double(0.0), double(12008080.0), temperature, log_temperature);}
    
double call_forward_reaction_139(const double& temperature, const double& log_temperature)  { return arrhenius(double(286000000.00000006), double(0.0), double(4686080.0), temperature, log_temperature);}
    
double call_forward_reaction_140(const double& temperature, const double& log_temperature)  { return arrhenius(double(30100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    

double
call_forward_reaction_141(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_142(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_143(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_144(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_145(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_146(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
call_forward_reaction_147(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double call_forward_reaction_148(const double& temperature, const double& log_temperature)  { return arrhenius(double(9000000000.000002), double(0.0), double(-3200760.0), temperature, log_temperature);}
    
double
call_forward_reaction_149(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return falloff_troe(double(5650000000000001.0), double(-0.97), double(61023640.0), double(1070000000000.0), double(0.63), double(70688680.0), double(0.36), double(49999.99999999999), double(16935.0), double(122.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double call_forward_reaction_150(const double& temperature, const double& log_temperature)  { return arrhenius(double(454000000000.00006), double(0.0), double(8200640.0), temperature, log_temperature);}
    
double call_forward_reaction_151(const double& temperature, const double& log_temperature)  { return arrhenius(double(4930000000.000001), double(0.0), double(15648160.0), temperature, log_temperature);}
    
double call_forward_reaction_152(const double& temperature, const double& log_temperature)  { return arrhenius(double(52700000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_153(const double& temperature, const double& log_temperature)  { return arrhenius(double(158000000000.00003), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_154(const double& temperature, const double& log_temperature)  { return arrhenius(double(12000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_155(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return third_body(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature, mixture_concentration);}
    
double call_forward_reaction_156(const double& temperature, const double& log_temperature)  { return arrhenius(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_157(const double& temperature, const double& log_temperature)  { return arrhenius(double(23000000.000000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_158(const double& temperature, const double& log_temperature)  { return arrhenius(double(6080000000.000001), double(0.0), double(0.0), temperature, log_temperature);}
    
double call_forward_reaction_159(const double& temperature, const double& log_temperature)  { return arrhenius(double(0.23500000000000004), double(3.62), double(47153680.0), temperature, log_temperature);}
    
double call_forward_reaction_160(const double& temperature, const double& log_temperature)  { return arrhenius(double(8130.000000000001), double(1.88), double(765672.0), temperature, log_temperature);}
    
double call_forward_reaction_161(const double& temperature, const double& log_temperature)  { return arrhenius(double(3700000.0000000005), double(0.907), double(3510376.0), temperature, log_temperature);}
    
double call_forward_reaction_162(const double& temperature, const double& log_temperature)  { return arrhenius(double(14.000000000000002), double(2.62), double(1920456.0), temperature, log_temperature);}
    
double call_forward_reaction_163(const double& temperature, const double& log_temperature)  { return arrhenius(double(71000000000.00002), double(0.0), double(251081840.0), temperature, log_temperature);}
    
double call_forward_reaction_164(const double& temperature, const double& log_temperature)  { return arrhenius(double(22.300000000000004), double(2.745), double(9271744.0), temperature, log_temperature);}
    

double
call_forward_reaction_165(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double call_forward_reaction_166(const double& temperature, const double& log_temperature)  { return arrhenius(double(3790000000.0000005), double(0.0), double(74747160.0), temperature, log_temperature);}
    
double call_forward_reaction_167(const double& temperature, const double& log_temperature)  { return arrhenius(double(60200.00000000001), double(1.56), double(69579920.0), temperature, log_temperature);}
    

double
call_forward_reaction_168(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double dcall_forward_reaction_22_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dthird_body_dtemperature(double(480000000000000.06), double(-1.2), double(74199056.0), temperature, log_temperature, mixture_concentration + (double(12.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double dcall_forward_reaction_22_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dthird_body_dlog_temperature(double(480000000000000.06), double(-1.2), double(74199056.0), temperature, log_temperature, mixture_concentration + (double(12.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species dcall_forward_reaction_22_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(12.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};return scale_gen(dthird_body_dmixture_concentration(double(480000000000000.06), double(-1.2), double(74199056.0), temperature, log_temperature, mixture_concentration + (double(12.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]),dmixture_concentration_dspecies);}
...
double
dcall_forward_reaction_32_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(2.4300000000000004e+16), double(-1.6), double(0.0), double(51300000000.00001), double(0.15), double(0.0), double(0.514), double(22850.0), double(10350.0), double(152.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_32_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(2.4300000000000004e+16), double(-1.6), double(0.0), double(51300000000.00001), double(0.15), double(0.0), double(0.514), double(22850.0), double(10350.0), double(152.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_32_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(2.4300000000000004e+16), double(-1.6), double(0.0), double(51300000000.00001), double(0.15), double(0.0), double(0.514), double(22850.0), double(10350.0), double(152.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
...
double
dcall_forward_reaction_38_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(3.2600000000000005e+18), double(-2.5), double(0.0), double(1020000000000.0001), double(-0.4), double(0.0), double(0.4), double(90000.0), double(90000.0), double(30.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_38_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(3.2600000000000005e+18), double(-2.5), double(0.0), double(1020000000000.0001), double(-0.4), double(0.0), double(0.4), double(90000.0), double(90000.0), double(30.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_38_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(3.2600000000000005e+18), double(-2.5), double(0.0), double(1020000000000.0001), double(-0.4), double(0.0), double(0.4), double(90000.0), double(90000.0), double(30.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
...
double
dcall_forward_reaction_40_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(1.3900000000000004e+28), double(-5.04), double(30961600.0), double(21300000000.000004), double(0.32), double(0.0), double(0.405), double(2811.0), double(9908.0), double(258.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_40_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(1.3900000000000004e+28), double(-5.04), double(30961600.0), double(21300000000.000004), double(0.32), double(0.0), double(0.405), double(2811.0), double(9908.0), double(258.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_40_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(1.3900000000000004e+28), double(-5.04), double(30961600.0), double(21300000000.000004), double(0.32), double(0.0), double(0.405), double(2811.0), double(9908.0), double(258.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
...
double dcall_forward_reaction_53_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(12000000000.000002), double(0.0), double(1970664.0), temperature, log_temperature);}
    
double dcall_forward_reaction_53_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(12000000000.000002), double(0.0), double(1970664.0), temperature, log_temperature);}
    
double dcall_forward_reaction_54_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_54_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
...
double dcall_forward_reaction_57_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(68000000000.000015), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_57_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(68000000000.000015), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_58_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(31300000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_58_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(31300000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_59_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(15100000000.000002), double(0.0), double(-1803304.0), temperature, log_temperature);}
    
double dcall_forward_reaction_59_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(15100000000.000002), double(0.0), double(-1803304.0), temperature, log_temperature);}
    

double
dcall_forward_reaction_60_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_60_dpressure(const double& temperature, const double& pressure) 
{
...
double dcall_forward_reaction_61_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(9000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_61_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(9000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_62_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(13300000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_62_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(13300000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_63_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(6620000000.000001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_63_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(6620000000.000001), double(0.0), double(0.0), temperature, log_temperature);}
    
double
dcall_forward_reaction_64_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(4.190000000000001e+28), double(-5.533), double(25639552.0), double(186000000000.00003), double(-0.033), double(-594128.0), double(0.782), double(2755.0), double(6570.0), double(271.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_64_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(4.190000000000001e+28), double(-5.533), double(25639552.0), double(186000000000.00003), double(-0.033), double(-594128.0), double(0.782), double(2755.0), double(6570.0), double(271.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_64_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(4.190000000000001e+28), double(-5.533), double(25639552.0), double(186000000000.00003), double(-0.033), double(-594128.0), double(0.782), double(2755.0), double(6570.0), double(271.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double
dcall_forward_reaction_65_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(4.4000000000000005e+35), double(-6.1), double(393295999.99999994), double(37000000000000.0), double(0.0), double(301147584.0), double(0.932), double(1540.0), double(10300.0), double(197.00000000000003), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_65_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(4.4000000000000005e+35), double(-6.1), double(393295999.99999994), double(37000000000000.0), double(0.0), double(301147584.0), double(0.932), double(1540.0), double(10300.0), double(197.00000000000003), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_65_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(4.4000000000000005e+35), double(-6.1), double(393295999.99999994), double(37000000000000.0), double(0.0), double(301147584.0), double(0.932), double(1540.0), double(10300.0), double(197.00000000000003), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double dcall_forward_reaction_66_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(5670000000.000001), double(0.361), double(19284056.0), temperature, log_temperature);}
    
double dcall_forward_reaction_66_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(5670000000.000001), double(0.361), double(19284056.0), temperature, log_temperature);}
    
double dcall_forward_reaction_67_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dthird_body_dtemperature(double(11400000000.000002), double(0.582), double(60228680.0), temperature, log_temperature, mixture_concentration);}
    
double dcall_forward_reaction_67_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dthird_body_dlog_temperature(double(11400000000.000002), double(0.582), double(60228680.0), temperature, log_temperature, mixture_concentration);}
    
Species dcall_forward_reaction_67_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return {double(0),1.0*dthird_body_dmixture_concentration(double(11400000000.000002), double(0.582), double(60228680.0), temperature, log_temperature, mixture_concentration),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0)};}
    
double dcall_forward_reaction_68_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(416000000.00000006), double(0.57), double(11556208.0), temperature, log_temperature);}
    
double dcall_forward_reaction_68_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(416000000.00000006), double(0.57), double(11556208.0), temperature, log_temperature);}
    
double dcall_forward_reaction_69_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(78200.00000000001), double(1.63), double(-4414120.0), temperature, log_temperature);}
    
double dcall_forward_reaction_69_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(78200.00000000001), double(1.63), double(-4414120.0), temperature, log_temperature);}
    
double dcall_forward_reaction_70_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(244.00000000000006), double(2.5), double(152548640.0), temperature, log_temperature);}
    
double dcall_forward_reaction_70_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(244.00000000000006), double(2.5), double(152548640.0), temperature, log_temperature);}
    
double dcall_forward_reaction_71_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(96400000000.00002), double(0.0), double(-2163128.0), temperature, log_temperature);}
    
double dcall_forward_reaction_71_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(96400000000.00002), double(0.0), double(-2163128.0), temperature, log_temperature);}
    
double dcall_forward_reaction_72_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(7.400000000000001e-05), double(4.21), double(4686080.0), temperature, log_temperature);}
    
double dcall_forward_reaction_72_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(7.400000000000001e-05), double(4.21), double(4686080.0), temperature, log_temperature);}
    
double dcall_forward_reaction_73_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(13300000000.000002), double(0.0), double(-2301200.0), temperature, log_temperature);}
    
double dcall_forward_reaction_73_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(13300000000.000002), double(0.0), double(-2301200.0), temperature, log_temperature);}
    
double dcall_forward_reaction_74_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(5.400000000000001), double(2.81), double(24526608.0), temperature, log_temperature);}
    
double dcall_forward_reaction_74_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(5.400000000000001), double(2.81), double(24526608.0), temperature, log_temperature);}
    
double
dcall_forward_reaction_75_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(1.27e+30), double(-5.57), double(15974512.0), double(211000000000.00003), double(0.0), double(0.0), double(0.37), double(61.0), double(90000.0), double(3315.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_75_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(1.27e+30), double(-5.57), double(15974512.0), double(211000000000.00003), double(0.0), double(0.0), double(0.37), double(61.0), double(90000.0), double(3315.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_75_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(1.27e+30), double(-5.57), double(15974512.0), double(211000000000.00003), double(0.0), double(0.0), double(0.37), double(61.0), double(90000.0), double(3315.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double dcall_forward_reaction_76_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(53900000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_76_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(53900000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_77_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(23100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_77_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(23100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_78_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(42.900000000000006), double(2.57), double(16727632.0), temperature, log_temperature);}
    
double dcall_forward_reaction_78_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(42.900000000000006), double(2.57), double(16727632.0), temperature, log_temperature);}
    

double
dcall_forward_reaction_79_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_79_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_80_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_80_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double dcall_forward_reaction_81_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(116.00000000000001), double(2.228), double(-12644048.0), temperature, log_temperature);}
    
double dcall_forward_reaction_81_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(116.00000000000001), double(2.228), double(-12644048.0), temperature, log_temperature);}
    
double dcall_forward_reaction_82_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(10400000000.000002), double(0.0), double(-2468560.0), temperature, log_temperature);}
    
double dcall_forward_reaction_82_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(10400000000.000002), double(0.0), double(-2468560.0), temperature, log_temperature);}
    
double dcall_forward_reaction_83_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(7550000000.000001), double(0.0), double(118394648.0), temperature, log_temperature);}
    
double dcall_forward_reaction_83_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(7550000000.000001), double(0.0), double(118394648.0), temperature, log_temperature);}
    
double dcall_forward_reaction_84_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(0.0686), double(2.86), double(40869312.0), temperature, log_temperature);}
    
double dcall_forward_reaction_84_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(0.0686), double(2.86), double(40869312.0), temperature, log_temperature);}
    
double dcall_forward_reaction_85_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_85_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_86_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(72300000000.00002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_86_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(72300000000.00002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_87_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(14000000000.000002), double(0.0), double(-2079448.0), temperature, log_temperature);}
    
double dcall_forward_reaction_87_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(14000000000.000002), double(0.0), double(-2079448.0), temperature, log_temperature);}
    
double dcall_forward_reaction_88_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(26200000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_88_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(26200000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_89_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(0.031900000000000005), double(3.36), double(18033040.0), temperature, log_temperature);}
    
double dcall_forward_reaction_89_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(0.031900000000000005), double(3.36), double(18033040.0), temperature, log_temperature);}
    
double
dcall_forward_reaction_90_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(60200000000000.01), double(-0.5468), double(75412416.0), double(11300000000.0), double(1.21), double(100729800.0), double(0.341), double(1000.0), double(2339.0), double(28.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_90_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(60200000000000.01), double(-0.5468), double(75412416.0), double(11300000000.0), double(1.21), double(100729800.0), double(0.341), double(1000.0), double(2339.0), double(28.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_90_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(60200000000000.01), double(-0.5468), double(75412416.0), double(11300000000.0), double(1.21), double(100729800.0), double(0.341), double(1000.0), double(2339.0), double(28.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double dcall_forward_reaction_91_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(37900000000.00001), double(0.0), double(2493664.0), temperature, log_temperature);}
    
double dcall_forward_reaction_91_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(37900000000.00001), double(0.0), double(2493664.0), temperature, log_temperature);}
    
double dcall_forward_reaction_92_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(388000000000.00006), double(-0.264), double(-108784.0), temperature, log_temperature);}
    
double dcall_forward_reaction_92_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(388000000000.00006), double(-0.264), double(-108784.0), temperature, log_temperature);}
    
double dcall_forward_reaction_93_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(197000000.00000003), double(0.414), double(1016712.0), temperature, log_temperature);}
    
double dcall_forward_reaction_93_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(197000000.00000003), double(0.414), double(1016712.0), temperature, log_temperature);}
    
double dcall_forward_reaction_94_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(3780000000.0000005), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_94_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(3780000000.0000005), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_95_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(18100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_95_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(18100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_96_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(63200000.00000001), double(0.0), double(10890952.0), temperature, log_temperature);}
    
double dcall_forward_reaction_96_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(63200000.00000001), double(0.0), double(10890952.0), temperature, log_temperature);}
    
double dcall_forward_reaction_97_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(24000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_97_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(24000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_98_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(6000000000.000001), double(0.0), double(46024000.0), temperature, log_temperature);}
    
double dcall_forward_reaction_98_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(6000000000.000001), double(0.0), double(46024000.0), temperature, log_temperature);}
    
double dcall_forward_reaction_99_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(614.0000000000001), double(2.5), double(40116192.0), temperature, log_temperature);}
    
double dcall_forward_reaction_99_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(614.0000000000001), double(2.5), double(40116192.0), temperature, log_temperature);}
    
double dcall_forward_reaction_100_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(693000.0000000001), double(1.56), double(35501240.0), temperature, log_temperature);}
    
double dcall_forward_reaction_100_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(693000.0000000001), double(1.56), double(35501240.0), temperature, log_temperature);}
    
double dcall_forward_reaction_101_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(1000.0000000000002), double(2.182), double(10234064.0), temperature, log_temperature);}
    
double dcall_forward_reaction_101_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(1000.0000000000002), double(2.182), double(10234064.0), temperature, log_temperature);}
    
double dcall_forward_reaction_102_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(30000000000.000004), double(0.0), double(-1661048.0), temperature, log_temperature);}
    
double dcall_forward_reaction_102_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(30000000000.000004), double(0.0), double(-1661048.0), temperature, log_temperature);}
    
double dcall_forward_reaction_103_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(2460.0000000000005), double(2.0), double(34601680.0), temperature, log_temperature);}
    
double dcall_forward_reaction_103_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(2460.0000000000005), double(2.0), double(34601680.0), temperature, log_temperature);}
    
double dcall_forward_reaction_104_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(18700000000.000004), double(0.0), double(-2079448.0), temperature, log_temperature);}
    
double dcall_forward_reaction_104_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(18700000000.000004), double(0.0), double(-2079448.0), temperature, log_temperature);}
    
double dcall_forward_reaction_105_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(132000000000.00002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_105_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(132000000000.00002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_106_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(173000000000.00003), double(-0.112), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_106_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(173000000000.00003), double(-0.112), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_107_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(29500000000.000004), double(0.0), double(4656792.0), temperature, log_temperature);}
    
double dcall_forward_reaction_107_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(29500000000.000004), double(0.0), double(4656792.0), temperature, log_temperature);}
    
double dcall_forward_reaction_108_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(1630000000.0000002), double(0.0), double(3573136.0), temperature, log_temperature);}
    
double dcall_forward_reaction_108_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(1630000000.0000002), double(0.0), double(3573136.0), temperature, log_temperature);}
    
double dcall_forward_reaction_109_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(18800000000000.004), double(-0.59), double(606680.0), temperature, log_temperature);}
    
double dcall_forward_reaction_109_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(18800000000000.004), double(-0.59), double(606680.0), temperature, log_temperature);}
    
double dcall_forward_reaction_110_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(37900000000.00001), double(0.13), double(-899560.0), temperature, log_temperature);}
    
double dcall_forward_reaction_110_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(37900000000.00001), double(0.13), double(-899560.0), temperature, log_temperature);}
    
double dcall_forward_reaction_111_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(50000000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_111_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(50000000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_112_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_112_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_113_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(10000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_113_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(10000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double
dcall_forward_reaction_114_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(3.6300000000000005e+21), double(-3.38), double(3543848.0), double(554000.0000000001), double(1.64), double(8769664.0), double(0.215), double(1043.0), double(2341.0), double(10.7), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_114_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(3.6300000000000005e+21), double(-3.38), double(3543848.0), double(554000.0000000001), double(1.64), double(8769664.0), double(0.215), double(1043.0), double(2341.0), double(10.7), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_114_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(3.6300000000000005e+21), double(-3.38), double(3543848.0), double(554000.0000000001), double(1.64), double(8769664.0), double(0.215), double(1043.0), double(2341.0), double(10.7), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double dcall_forward_reaction_115_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(939000.0000000001), double(1.4), double(9229904.0), temperature, log_temperature);}
    
double dcall_forward_reaction_115_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(939000.0000000001), double(1.4), double(9229904.0), temperature, log_temperature);}
    
double dcall_forward_reaction_116_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(235000.00000000003), double(1.4), double(9229904.0), temperature, log_temperature);}
    
double dcall_forward_reaction_116_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(235000.00000000003), double(1.4), double(9229904.0), temperature, log_temperature);}
    

double
dcall_forward_reaction_117_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_117_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_118_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_118_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double dcall_forward_reaction_119_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(7750.000000000001), double(1.605), double(64015200.0), temperature, log_temperature);}
    
double dcall_forward_reaction_119_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(7750.000000000001), double(1.605), double(64015200.0), temperature, log_temperature);}
    
double dcall_forward_reaction_120_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(23200.000000000004), double(1.605), double(64015200.0), temperature, log_temperature);}
    
double dcall_forward_reaction_120_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(23200.000000000004), double(1.605), double(64015200.0), temperature, log_temperature);}
    
double
dcall_forward_reaction_121_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(2.6900000000000006e+27), double(-5.11), double(29685480.0), double(810000000.0000001), double(0.5), double(18869840.0), double(0.591), double(1226.0), double(5185.0), double(275.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_121_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(2.6900000000000006e+27), double(-5.11), double(29685480.0), double(810000000.0000001), double(0.5), double(18869840.0), double(0.591), double(1226.0), double(5185.0), double(275.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_121_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(2.6900000000000006e+27), double(-5.11), double(29685480.0), double(810000000.0000001), double(0.5), double(18869840.0), double(0.591), double(1226.0), double(5185.0), double(275.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double dcall_forward_reaction_122_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(42000.00000000001), double(1.9), double(49580400.0), temperature, log_temperature);}
    
double dcall_forward_reaction_122_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(42000.00000000001), double(1.9), double(49580400.0), temperature, log_temperature);}
    
double dcall_forward_reaction_123_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(777000.0000000001), double(1.45), double(11631520.0), temperature, log_temperature);}
    
double dcall_forward_reaction_123_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(777000.0000000001), double(1.45), double(11631520.0), temperature, log_temperature);}
    
double dcall_forward_reaction_124_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(10000000000.000002), double(0.0), double(43095200.0), temperature, log_temperature);}
    
double dcall_forward_reaction_124_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(10000000000.000002), double(0.0), double(43095200.0), temperature, log_temperature);}
    
double dcall_forward_reaction_125_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(1080000000.0000002), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double dcall_forward_reaction_125_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(1080000000.0000002), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double dcall_forward_reaction_126_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(361000000.00000006), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double dcall_forward_reaction_126_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(361000000.00000006), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double dcall_forward_reaction_127_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(361000000.00000006), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double dcall_forward_reaction_127_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(361000000.00000006), double(0.0), double(5652584.0), temperature, log_temperature);}
    
double dcall_forward_reaction_128_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(11.200000000000001), double(2.74), double(9288480.0), temperature, log_temperature);}
    
double dcall_forward_reaction_128_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(11.200000000000001), double(2.74), double(9288480.0), temperature, log_temperature);}
    
double dcall_forward_reaction_129_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(680000000.0000001), double(0.0), double(-4238392.0), temperature, log_temperature);}
    
double dcall_forward_reaction_129_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(680000000.0000001), double(0.0), double(-4238392.0), temperature, log_temperature);}
    
double dcall_forward_reaction_130_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(1010000000.0000001), double(0.0), double(-4238392.0), temperature, log_temperature);}
    
double dcall_forward_reaction_130_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(1010000000.0000001), double(0.0), double(-4238392.0), temperature, log_temperature);}
    
double dcall_forward_reaction_131_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(145000000000.00003), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_131_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(145000000000.00003), double(0.0), double(0.0), temperature, log_temperature);}
...
return scale_gen(dfalloff_troe_dmixture_concentration(double(1.4000000000000004e+24), double(-3.86), double(13890880.0), double(38800000000.00001), double(0.2), double(0.0), double(0.782), double(2663.0), double(6095.0), double(207.49999999999997), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double dcall_forward_reaction_133_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(1210000000.0000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_133_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(1210000000.0000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_134_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(30100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_134_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(30100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_135_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(21000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_135_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(21000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_136_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(16700000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_136_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(16700000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_137_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(1140000000.0000002), double(0.0), double(5857599.999999999), temperature, log_temperature);}
    
double dcall_forward_reaction_137_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(1140000000.0000002), double(0.0), double(5857599.999999999), temperature, log_temperature);}
    
double dcall_forward_reaction_138_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(41800000000.00001), double(0.0), double(12008080.0), temperature, log_temperature);}
    
double dcall_forward_reaction_138_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(41800000000.00001), double(0.0), double(12008080.0), temperature, log_temperature);}
    
double dcall_forward_reaction_139_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(286000000.00000006), double(0.0), double(4686080.0), temperature, log_temperature);}
    
double dcall_forward_reaction_139_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(286000000.00000006), double(0.0), double(4686080.0), temperature, log_temperature);}
    
double dcall_forward_reaction_140_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(30100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_140_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(30100000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    

double
dcall_forward_reaction_141_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_141_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_142_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_142_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_143_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_143_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_144_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_144_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_145_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_145_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_146_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_146_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double
dcall_forward_reaction_147_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_147_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double dcall_forward_reaction_148_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(9000000000.000002), double(0.0), double(-3200760.0), temperature, log_temperature);}
    
double dcall_forward_reaction_148_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(9000000000.000002), double(0.0), double(-3200760.0), temperature, log_temperature);}
    
double
dcall_forward_reaction_149_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dtemperature(double(5650000000000001.0), double(-0.97), double(61023640.0), double(1070000000000.0), double(0.63), double(70688680.0), double(0.36), double(49999.99999999999), double(16935.0), double(122.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
double
dcall_forward_reaction_149_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dfalloff_troe_dlog_temperature(double(5650000000000001.0), double(-0.97), double(61023640.0), double(1070000000000.0), double(0.63), double(70688680.0), double(0.36), double(49999.99999999999), double(16935.0), double(122.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]);}
    
Species
dcall_forward_reaction_149_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { Species dmixture_concentration_dspecies = {double(2.0), double(1.0), double(1.0), double(1.0), double(1.0), double(6.0), double(1.0), double(1.0), double(1.0), double(1.0), double(1.0), double(2.0), double(1.5), double(2.0), double(1.0), double(2.5), double(1.0), double(3.0), double(1.0), double(3.0), double(1.0), double(1.0), double(1.0), double(1.0)};
return scale_gen(dfalloff_troe_dmixture_concentration(double(5650000000000001.0), double(-0.97), double(61023640.0), double(1070000000000.0), double(0.63), double(70688680.0), double(0.36), double(49999.99999999999), double(16935.0), double(122.0), temperature, log_temperature, mixture_concentration + (double(2.0)-double(1))*species[0] + (double(6.0)-double(1))*species[5] + (double(2.0)-double(1))*species[11] + (double(1.5)-double(1))*species[12] + (double(2.0)-double(1))*species[13] + (double(2.5)-double(1))*species[15] + (double(3.0)-double(1))*species[17] + (double(3.0)-double(1))*species[19]), dmixture_concentration_dspecies);}
    
double dcall_forward_reaction_150_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(454000000000.00006), double(0.0), double(8200640.0), temperature, log_temperature);}
    
double dcall_forward_reaction_150_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(454000000000.00006), double(0.0), double(8200640.0), temperature, log_temperature);}
    
double dcall_forward_reaction_151_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(4930000000.000001), double(0.0), double(15648160.0), temperature, log_temperature);}
    
double dcall_forward_reaction_151_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(4930000000.000001), double(0.0), double(15648160.0), temperature, log_temperature);}
    
double dcall_forward_reaction_152_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(52700000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_152_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(52700000000.00001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_153_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(158000000000.00003), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_153_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(158000000000.00003), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_154_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(12000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_154_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(12000000000.000002), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_155_dtemperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dthird_body_dtemperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature, mixture_concentration);}
    
double dcall_forward_reaction_155_dlog_temperature(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return dthird_body_dlog_temperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature, mixture_concentration);}
    
Species dcall_forward_reaction_155_dspecies(const Species& species, const double& temperature, const double& log_temperature, const double& mixture_concentration)  { return {double(0),double(0),double(0),double(0),1.0*dthird_body_dmixture_concentration(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature, mixture_concentration),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0),double(0)};}
    
double dcall_forward_reaction_156_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_156_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(30000000000.000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_157_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(23000000.000000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_157_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(23000000.000000004), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_158_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(6080000000.000001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_158_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(6080000000.000001), double(0.0), double(0.0), temperature, log_temperature);}
    
double dcall_forward_reaction_159_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(0.23500000000000004), double(3.62), double(47153680.0), temperature, log_temperature);}
    
double dcall_forward_reaction_159_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(0.23500000000000004), double(3.62), double(47153680.0), temperature, log_temperature);}
    
double dcall_forward_reaction_160_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(8130.000000000001), double(1.88), double(765672.0), temperature, log_temperature);}
    
double dcall_forward_reaction_160_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(8130.000000000001), double(1.88), double(765672.0), temperature, log_temperature);}
    
double dcall_forward_reaction_161_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(3700000.0000000005), double(0.907), double(3510376.0), temperature, log_temperature);}
    
double dcall_forward_reaction_161_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(3700000.0000000005), double(0.907), double(3510376.0), temperature, log_temperature);}
    
double dcall_forward_reaction_162_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(14.000000000000002), double(2.62), double(1920456.0), temperature, log_temperature);}
    
double dcall_forward_reaction_162_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(14.000000000000002), double(2.62), double(1920456.0), temperature, log_temperature);}
    
double dcall_forward_reaction_163_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(71000000000.00002), double(0.0), double(251081840.0), temperature, log_temperature);}
    
double dcall_forward_reaction_163_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(71000000000.00002), double(0.0), double(251081840.0), temperature, log_temperature);}
    
double dcall_forward_reaction_164_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(22.300000000000004), double(2.745), double(9271744.0), temperature, log_temperature);}
    
double dcall_forward_reaction_164_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(22.300000000000004), double(2.745), double(9271744.0), temperature, log_temperature);}
    

double
dcall_forward_reaction_165_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_165_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
...
double dcall_forward_reaction_166_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(3790000000.0000005), double(0.0), double(74747160.0), temperature, log_temperature);}
    
double dcall_forward_reaction_166_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(3790000000.0000005), double(0.0), double(74747160.0), temperature, log_temperature);}
    
double dcall_forward_reaction_167_dtemperature(const double& temperature, const double& log_temperature)  { return darrhenius_dtemperature(double(60200.00000000001), double(1.56), double(69579920.0), temperature, log_temperature);}
    
double dcall_forward_reaction_167_dlog_temperature(const double& temperature, const double& log_temperature)  { return darrhenius_dlog_temperature(double(60200.00000000001), double(1.56), double(69579920.0), temperature, log_temperature);}
    

double
dcall_forward_reaction_168_dtemperature(const double& temperature, const double& pressure) 
{
        double log_pressure = log_gen(pressure);
        double rate = double(0);
...
double
dcall_forward_reaction_168_dpressure(const double& temperature, const double& pressure) 
{
        double inv_universal_gas_constant_temperature = inv_gen(universal_gas_constant() * temperature); 
        double log_pressure = log_gen(pressure);
        double dlog_pressure_dpressure = dlog_da(pressure);
